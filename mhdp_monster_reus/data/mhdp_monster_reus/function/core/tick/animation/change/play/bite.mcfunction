#> mhdp_monster_reus:core/tick/animation/change/play/bite
#
# アニメーション変更処理 尻尾攻撃
#
...
# 再生アニメーション決定
    execute if entity @s[tag=Mns.Temp.Right] run tag @s add Anim.Bite.R
    execute if entity @s[tag=!Mns.Temp.Right] run tag @s add Anim.Bite.L
