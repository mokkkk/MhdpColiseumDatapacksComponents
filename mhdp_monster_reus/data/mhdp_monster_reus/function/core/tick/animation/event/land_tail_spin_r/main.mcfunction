...
# 効果音
    ...
    execute if score @s aj.land_tail_spin_r.frame matches 25..27 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound entity.ravager.attack master @s ^ ^1 ^1 1 1 0.4
    execute if score @s aj.land_tail_spin_r.frame matches 70..72 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound entity.ravager.attack master @s ^ ^1 ^1 1 1 0.4
    execute if score @s aj.land_tail_spin_r.frame matches 25 run playsound entity.player.attack.sweep master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 1 1
    execute if score @s aj.land_tail_spin_r.frame matches 70 run playsound entity.player.attack.sweep master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 1 1
