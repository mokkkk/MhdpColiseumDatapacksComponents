#> mhdp_monster_reus:core/tick/animation/event/fly_flame_vertical/effect/start
#
...
# 演出
    execute as @n[type=marker,tag=Mns.Reus.Attack.Flame,limit=1] at @s run function mhdp_monster_reus:core/tick/animation/event/fly_flame_vertical/effect/shot
    execute as @n[type=marker,tag=Mns.Reus.Attack.Flame,limit=1] at @s run function mhdp_monster_reus:core/tick/animation/event/fly_flame_vertical/effect/loop
