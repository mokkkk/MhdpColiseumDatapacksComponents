...
# 攻撃
    execute if score @s aj.land_tail_spin_l.frame matches 25..37 run function mhdp_monster_reus:core/tick/animation/event/land_tail_spin_l/attack
    execute if score @s aj.land_tail_spin_l.frame matches 70..82 run function mhdp_monster_reus:core/tick/animation/event/land_tail_spin_l/attack
