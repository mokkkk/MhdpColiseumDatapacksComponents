...
# 効果音
    execute if score @s aj.land_state_paralysis_end.frame matches 14..18 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound entity.ravager.attack master @s ^ ^1 ^1 0.4 0.7 0.4
