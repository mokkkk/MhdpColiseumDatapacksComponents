...
# 演出
    ...
    execute if score @s aj.fly_anger.frame matches 17..33 at @a[tag=!Ply.State.IsSilent,distance=..48] facing entity @s feet as @p run playsound entity.ender_dragon.growl master @s ^ ^1 ^1 0.4 0.5 0.4
    execute if score @s aj.fly_anger.frame matches 17..33 at @a[tag=!Ply.State.IsSilent,distance=..48] facing entity @s feet as @p run playsound entity.ravager.attack master @s ^ ^1 ^1 0.4 0.7 0.4
