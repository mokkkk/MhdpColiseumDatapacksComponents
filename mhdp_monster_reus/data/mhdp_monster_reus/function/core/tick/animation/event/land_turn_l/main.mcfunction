...
# 軸合わせ
    execute if score @s aj.land_turn_l.frame matches 2 at @s run function mhdp_monster_reus:core/tick/animation/event/land_turn_l/turn_start
    execute if score @s aj.land_turn_l.frame matches 2..16 at @s run function mhdp_monsters:core/util/other/turn_to_target_rotate
