...
# 剝ぎ取り可能
    execute if score @s aj.death_flying.frame matches 69 run tag @s add Mns.State.IsCanCarving
    execute if score @s aj.death_flying.frame matches 69 run scoreboard players set @s Mns.General.Carving.Count 3
