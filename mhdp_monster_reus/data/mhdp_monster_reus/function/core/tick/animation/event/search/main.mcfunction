#> mhdp_monster_reus:core/tick/animation/event/search/main
#
# アニメーションイベントハンドラ 警戒中
#
...
# 終了
    execute if score @s aj.search.frame matches 74 run function mhdp_monster_reus:core/tick/animation/event/search/end
