...
# 軸合わせ
    execute if score @s aj.land_backstep.frame matches 2..28 run tag @n[tag=Mns.Target.Reus] add Temp.Rotate.Target
    execute if score @s aj.land_backstep.frame matches 2..28 at @s run function mhdp_monsters:core/util/other/turn_to_target_accurate
