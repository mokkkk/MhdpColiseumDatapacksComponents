#> mhdp_monster_reus:core/tick/animation/event/land_tail_spin_l/attack
#
...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_reus:core/tick/animation/event/land_tail_spin_l/attack_hit with entity @s data.locators.pos_tail_2
        execute if entity @s[tag=!Mns.Break.Tail] on passengers if entity @s[tag=aj.data] run function mhdp_monster_reus:core/tick/animation/event/land_tail_spin_l/attack_hit with entity @s data.locators.pos_tail_3
