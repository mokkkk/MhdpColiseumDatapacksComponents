...
# 軸合わせ
    execute if score @s aj.fly_flame_sweep.frame matches 2..30 run tag @n[tag=Mns.Target.Reus] add Temp.Rotate.Target
    execute if score @s aj.fly_flame_sweep.frame matches 2..30 at @s run function mhdp_monsters:core/util/other/turn_to_target_accurate
