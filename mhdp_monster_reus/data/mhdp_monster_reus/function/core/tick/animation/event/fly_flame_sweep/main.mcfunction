...
# 状態変更
    execute if score @s aj.fly_flame_sweep.frame matches 63 run tag @s remove Mns.State.IsFlying
    execute if score @s aj.fly_flame_sweep.frame matches 63 run tag @s remove Mns.Reus.State.Flying
