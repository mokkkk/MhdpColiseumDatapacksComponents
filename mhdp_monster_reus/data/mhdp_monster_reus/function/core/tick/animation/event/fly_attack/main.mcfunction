...
# 軸合わせ・弱め
    execute if score @s aj.fly_attack.frame matches 2 run function mhdp_monster_reus:core/tick/animation/event/fly_attack/turn_start
    ...
    execute if score @s aj.fly_attack.frame matches 2..10 at @s run function mhdp_monsters:core/util/other/turn_to_target_rotate
