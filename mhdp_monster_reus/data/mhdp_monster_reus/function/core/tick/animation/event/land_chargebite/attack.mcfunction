#> mhdp_monster_reus:core/tick/animation/event/land_chargebite/attack
#
...
# データ読み込み
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:monster_data AttackData[{Uid:1002}].Attacks[{Name:"ChargeBite"}]
