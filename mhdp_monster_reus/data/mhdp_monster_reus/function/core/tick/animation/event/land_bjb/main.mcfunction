...
# 攻撃
    execute if score @s aj.land_bjb.frame matches 14 run summon area_effect_cloud ^ ^ ^7 {Duration:10,DurationOnUse:0,Tags:["Mns.ShotPos.Reus"]}
    execute if score @s aj.land_bjb.frame matches 20 positioned ^ ^2.6 ^4 run function mhdp_monster_reus:core/tick/animation/event/land_bjb/shot
