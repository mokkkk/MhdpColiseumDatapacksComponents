...
# 軸合わせ・弱め
    execute if score @s aj.land_bite_r.frame matches 2 run function mhdp_monster_reus:core/tick/animation/event/land_bite_r/turn_start
    ...
    execute if score @s aj.land_bite_r.frame matches 2..10 at @s run function mhdp_monsters:core/util/other/turn_to_target_rotate
...
# 効果音
    execute if score @s aj.land_bite_r.frame matches 2 run playsound entity.ender_dragon.flap master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 0.7
...
# 攻撃
    execute if score @s aj.land_bite_r.frame matches 22 rotated ~5 ~ run function mhdp_monster_reus:core/tick/animation/event/land_bite_r/attack
    execute if score @s aj.land_bite_r.frame matches 54 rotated ~-5 ~ run function mhdp_monster_reus:core/tick/animation/event/land_bite_r/attack
