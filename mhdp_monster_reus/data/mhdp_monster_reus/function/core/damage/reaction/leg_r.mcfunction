...
# アニメーション再生処理
    ...
    # アニメーション再生
            # function animated_java:reus_aj/animations/land_damage_l/tween {duration:1, to_frame: 0}
            function animated_java:reus_aj/animations/land_damage_down_l/tween {duration:1, to_frame: 0}
