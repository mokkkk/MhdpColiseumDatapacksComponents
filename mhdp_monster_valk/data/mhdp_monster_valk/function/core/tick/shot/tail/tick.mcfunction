#> mhdp_monster_valk:core/tick/shot/tail/tick
#
# 尻尾tick処理
#
...
# 移動
    execute if score @s Mns.Shot.Timer matches 1 run function mhdp_monster_valk:core/tick/shot/tail/move_start
    ...
    execute if score @s Mns.Shot.Timer matches 18 run function mhdp_monster_valk:core/tick/shot/tail/move_end
