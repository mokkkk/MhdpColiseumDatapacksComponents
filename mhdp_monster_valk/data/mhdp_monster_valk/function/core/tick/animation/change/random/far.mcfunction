#> mhdp_monster_dino:core/tick/animation/change/random/far
#
# 行動ランダム選択
#
...
# 決定
    function mhdp_monster_dino:core/tick/animation/change/random/macro/m.far with storage mhdp_core:temp Temp.AttackRandom
