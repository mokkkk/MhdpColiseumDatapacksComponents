...
# ヒット確認
    # 対プレイヤー
        ...
        execute positioned ^5 ^ ^3 as @a[tag=Ply.State.EnableDamage,distance=..3.5] run tag @s add Temp.Hit
        execute positioned ^-5 ^ ^3 as @a[tag=Ply.State.EnableDamage,distance=..3.5] run tag @s add Temp.Hit
        execute positioned ^10 ^ ^3 as @a[tag=Ply.State.EnableDamage,distance=..3.5] run tag @s add Temp.Hit
        execute positioned ^-10 ^ ^3 as @a[tag=Ply.State.EnableDamage,distance=..3.5] run tag @s add Temp.Hit
    ...
    # 対モンスター
        execute positioned ^ ^ ^3 as @e[type=slime,tag=Mns.HitBox,tag=!Mns.HitBox.DisableMnsDamage,tag=!Mns.HitBox.Valk,distance=..5.5] run tag @s add Temp.Hit
        execute positioned ^5 ^ ^3 as @e[type=slime,tag=Mns.HitBox,tag=!Mns.HitBox.DisableMnsDamage,tag=!Mns.HitBox.Valk,distance=..3.5] run tag @s add Temp.Hit
        execute positioned ^-5 ^ ^3 as @e[type=slime,tag=Mns.HitBox,tag=!Mns.HitBox.DisableMnsDamage,tag=!Mns.HitBox.Valk,distance=..3.5] run tag @s add Temp.Hit
        execute positioned ^10 ^ ^3 as @e[type=slime,tag=Mns.HitBox,tag=!Mns.HitBox.DisableMnsDamage,tag=!Mns.HitBox.Valk,distance=..3.5] run tag @s add Temp.Hit
        execute positioned ^-10 ^ ^3 as @e[type=slime,tag=Mns.HitBox,tag=!Mns.HitBox.DisableMnsDamage,tag=!Mns.HitBox.Valk,distance=..5.5] run tag @s add Temp.Hit
