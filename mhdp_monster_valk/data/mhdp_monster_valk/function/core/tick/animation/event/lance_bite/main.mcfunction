...
# 軸合わせ
    execute if score @s aj.lance_bite.frame matches 2 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Valk",Tick:10,MaxRotation:360}
    execute if score @s aj.lance_bite.frame matches 7 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Valk",Tick:10,MaxRotation:360}
    execute if score @s aj.lance_bite.frame matches 2..12 at @s run function mhdp_monsters:core/util/tick/event/alignment

# 移動
    execute if score @s aj.lance_bite.frame matches 21..27 at @s run tp @s ^ ^ ^0.9
...
# 効果音
    ...
    execute if score @s aj.lance_bite.frame matches 42 run function mhdp_monster_valk:core/tick/animation/event/lance_bite/sound
...
# 攻撃
    execute if score @s aj.lance_bite.frame matches 23 run function mhdp_monsters:core/util/tick/event/start_attack.m with storage mhdp_core:monster_data AttackData[{Uid:1004}].Attacks[{Name:"Bite"}]
    ...
    execute if score @s aj.lance_bite.frame matches 30 run function mhdp_monsters:core/util/tick/event/end_attack
