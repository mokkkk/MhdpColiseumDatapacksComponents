#> mhdp_monster_valk:core/tick/animation/event/lance_vertical_l_to_r/hit_swing
#
# アニメーションイベントハンドラ 翼槍叩きつけ 連携 振り下ろし中の当たり判定 (at_locator pos_wing_r_3 から実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_vertical_l_to_r/attack_swing
