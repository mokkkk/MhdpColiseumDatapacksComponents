#> mhdp_monster_valk:core/tick/animation/event/lance_spear_r_to_l/hit_l
#
# アニメーションイベントハンドラ 2連突き (左翼爪 当たり判定・at_locator から実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_spear_r_to_l/attack_l
