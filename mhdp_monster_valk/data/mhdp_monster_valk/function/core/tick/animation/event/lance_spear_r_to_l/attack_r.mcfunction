...
# ヒット確認
    # 対プレイヤー
        ...
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_r_to_l/m.attack with entity @s data.locators.pos_wing_r_4
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_r_to_l/m.attack with entity @s data.locators.pos_wing_r_5
