#> mhdp_monster_valk:core/tick/animation/event/lance_dashattack/attack_dash
#
# アニメーションイベントハンドラ 突進(体当たり) 突進中の当たり判定
#
...
# デバッグ用
    ...
    #         Player_Scale_X:2.8,Player_Scale_Y:3.8,Player_Scale_Z:3.8,\
    ...
    #         Entity_Scale_X:2.8,Entity_Scale_Y:3.8,Entity_Scale_Z:3.8\
    # }
