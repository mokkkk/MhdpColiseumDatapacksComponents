...
# 攻撃
    execute if score @s aj.shoot_shot_horizon.frame matches 10 positioned as @n[tag=Mns.Target.Valk] positioned ^ ^ ^-1 run summon area_effect_cloud ~ ~0.5 ~ {Duration:28,DurationOnUse:0,Tags:["Mns.ShotPos.Valk"]}
    execute if score @s aj.shoot_shot_horizon.frame matches 10 at @n[type=area_effect_cloud,tag=Mns.ShotPos.Valk] run summon area_effect_cloud ~ ~ ~ {Duration:28,DurationOnUse:0,Tags:["Mns.ShotPos.Valk2"]}
    execute if score @s aj.shoot_shot_horizon.frame matches 20..28 as @n[type=area_effect_cloud,tag=Mns.ShotPos.Valk] positioned as @s run tp @s ^-0.5 ^ ^-0.5
    ...
    execute if score @s aj.shoot_shot_horizon.frame matches 29..35 as @n[type=area_effect_cloud,tag=Mns.ShotPos.Valk2] positioned as @s run tp @s ^-0.5 ^ ^-0.5
