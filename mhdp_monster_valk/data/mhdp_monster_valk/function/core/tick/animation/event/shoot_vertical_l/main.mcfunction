...
#
# アニメーションイベントハンドラ 翼叩きつけ (左)
#
# @within function mhdp_monster_valk:core/tick/animation/event/tick

# 軸合わせ
    execute if score @s aj.shoot_vertical_l.frame matches 2 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Valk",Tick:10,MaxRotation:180}
    execute if score @s aj.shoot_vertical_l.frame matches 11 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Valk",Tick:10,MaxRotation:180}
    execute if score @s aj.shoot_vertical_l.frame matches 21 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Valk",Tick:10,MaxRotation:180}
    execute if score @s aj.shoot_vertical_l.frame matches 2..30 at @s run function mhdp_monsters:core/util/tick/event/alignment
...
# 効果音
    ...
    execute if score @s aj.shoot_vertical_l.frame matches 45..53 run function mhdp_monster_valk:core/tick/animation/event/shoot_vertical_l/particle

# 演出
    execute if score @s aj.shoot_vertical_l.frame matches 53 run data modify storage api: Arg.Override set value {Scale:6}
    execute if score @s aj.shoot_vertical_l.frame matches 53 positioned ^3 ^0 ^14 run function api:object/summon.m {ObjectId:10047}
...
# 攻撃2 (翼叩きつけ・振り下ろし中〜着弾まで)
    execute if score @s aj.shoot_vertical_l.frame matches 47 run function mhdp_monsters:core/util/tick/event/start_attack.m with storage mhdp_core:monster_data AttackData[{Uid:1004}].Attacks[{Name:"VerticalS.Left"}]
    execute if score @s aj.shoot_vertical_l.frame matches 47..50 run function mhdp_monster_valk:core/tick/animation/event/shoot_vertical_l/attack_swing
    ...
    execute if score @s aj.shoot_vertical_l.frame matches 53 run function mhdp_monsters:core/util/tick/event/end_attack

# モデル演出
    execute if score @s aj.shoot_vertical_l.frame matches 42 run function mhdp_monster_valk:core/util/models/ignite_start_left
    execute if score @s aj.shoot_vertical_l.frame matches 70 run function mhdp_monster_valk:core/util/models/ignite_end_left

# 接地
    function mhdp_monsters:core/util/tick/move/check_landing

# 状態更新 (相殺アニメ分岐用)
    execute if score @s aj.shoot_vertical_l.frame matches 48 run tag @s add Mns.Valk.State.Attack.Wing.L
    execute if score @s aj.shoot_vertical_l.frame matches 53 run tag @s remove Mns.Valk.State.Attack.Wing.L
