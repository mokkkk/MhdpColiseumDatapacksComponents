#> mhdp_monster_valk:core/tick/animation/event/shoot_vertical_r/attack_hand
#
...
# データ読み込み
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:monster_data AttackData[{Uid:1004}].Attacks[{Name:"Vertical.Hand"}]
