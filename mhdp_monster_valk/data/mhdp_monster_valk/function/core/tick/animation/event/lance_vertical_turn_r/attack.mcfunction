#> mhdp_monster_valk:core/tick/animation/event/lance_vertical_turn_r/attack
#
...
# 演出
    ...
    execute positioned ^-0.5 ^-3 ^0.3 facing entity @e[type=marker,tag=Mk.Field.Back,sort=random,limit=1] feet rotated ~ 0 run function mhdp_monsters:core/effect/crack_ground/start
    execute positioned ^ ^1 ^ rotated ~ -90 run function mhdp_monster_valk:core/tick/animation/event/lance_vertical_turn_r/particle_ring
