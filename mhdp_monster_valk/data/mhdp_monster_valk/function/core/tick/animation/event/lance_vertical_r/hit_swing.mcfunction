#> mhdp_monster_valk:core/tick/animation/event/lance_vertical_r/hit_swing
#
# アニメーションイベントハンドラ 翼槍叩きつけ 振り下ろし中の当たり判定 (at_locator pos_wing_r_3 から実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_vertical_r/attack_swing
