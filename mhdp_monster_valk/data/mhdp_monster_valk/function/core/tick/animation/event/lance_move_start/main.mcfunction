...
# 軸合わせ
    execute if score @s aj.lance_move_start.frame matches 1 run function mhdp_monster_valk:core/tick/animation/event/lance_move_start/turn_start
    execute if score @s aj.lance_move_start.frame matches 2..15 run function mhdp_monsters:core/util/other/turn_to_target_rotate
