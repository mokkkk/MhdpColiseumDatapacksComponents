#> mhdp_monster_valk:core/tick/animation/event/shoot_shot_forward/shot_c
#
...
# Object: Shot (10040)
    execute facing entity @n[type=area_effect_cloud,tag=Mns.ShotPos.Valk3] feet run function api:object/summon.m {ObjectId:10040}
