...
# 移動
    ...
    execute if score @s aj.lance_vertical_turn_r.frame matches 80..90 at @s run tp @s ^ ^ ^-0.2
    execute if score @s aj.lance_vertical_turn_r.frame matches 91..96 at @s run tp @s ^ ^ ^-0.1
...
# 2連
    execute if score @s aj.lance_vertical_turn_r.frame matches 65 run function animated_java:valk_aj/animations/lance_vertical_r_to_l/tween {duration:1, to_frame: 1}
