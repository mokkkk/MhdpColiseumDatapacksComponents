...
# 演出
    execute if score @s aj.lance_vertical_turn_r.frame matches 34 run data modify storage api: Arg.Override set value {Scale:8}
    execute if score @s aj.lance_vertical_turn_r.frame matches 34 positioned ^-2 ^1 ^-6 run function api:object/summon.m {ObjectId:10047}
