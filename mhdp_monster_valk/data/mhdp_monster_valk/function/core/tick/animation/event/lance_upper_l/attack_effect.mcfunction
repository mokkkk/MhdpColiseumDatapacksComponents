#> mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_effect
#
# アニメーションイベントハンドラ 翼槍突き上げ 前方一直線の演出 (attack から positioned で実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack
