...
# 移動
    ...
    execute if score @s aj.shoot_vertical_r.frame matches 6..19 unless entity @n[tag=Mns.Target.Valk,distance=..8] at @s run tp @s ^ ^ ^0.1
    execute if score @s aj.shoot_vertical_r.frame matches 20..30 unless entity @n[tag=Mns.Target.Valk,distance=..8] at @s run tp @s ^ ^ ^0.4
