...
# スタン中演出
    execute if entity @s[tag=Mns.State.IsStun] run function animated_java_valk:valk/at_locator {name:"pos_head",command:"function mhdp_monster_valk:core/tick/animation/event/lance_down_r/effect_stun"}
