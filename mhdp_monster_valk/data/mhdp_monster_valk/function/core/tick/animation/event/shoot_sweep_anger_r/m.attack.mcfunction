#> mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_r/m.attack
#
...
# ヒット確認
    ...
    $execute positioned ^$(posx) ^$(posy) ^$(posz) run particle dust{color:[1.000,0.412,0.412],scale:4} ^ ^ ^ 0.5 0.5 0.5 0.15 3
    $execute positioned ^$(posx) ^$(posy) ^$(posz) positioned ^ ^2.5 ^ run particle dust{color:[1.000,0.412,0.412],scale:4} ^ ^ ^ 0.5 0.5 0.5 0.15 3
    $execute positioned ^$(posx) ^$(posy) ^$(posz) positioned ^ ^5 ^ run particle dust{color:[1.000,0.412,0.412],scale:4} ^ ^ ^ 0.5 0.5 0.5 0.15 3
