#> mhdp_monster_valk:core/tick/animation/event/shoot_sweep_r/attack
#
...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_r/m.attack with entity @s data.locators.pos_wing_r_1
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_r/m.attack with entity @s data.locators.pos_wing_r_2
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_r/m.attack with entity @s data.locators.pos_wing_r_3
