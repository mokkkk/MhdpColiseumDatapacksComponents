#> mhdp_monster_valk:core/tick/animation/event/lance_vertical_r_to_l/attack
#
# アニメーションイベントハンドラ 翼槍叩きつけ 連携 (振り下ろし当たり判定・main から positioned で実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_vertical_r_to_l/main
...
# 演出
    ...
    execute positioned ^-1 ^ ^ rotated ~ 0 run function api:object/summon.m {ObjectId:16}
    execute positioned ^ ^1 ^ rotated ~ -90 run function mhdp_monster_valk:core/tick/animation/event/lance_vertical_r_to_l/particle_ring
