#> mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_l/hit_l
#
# アニメーションイベントハンドラ 翼槍回転斬り (左翼爪・突き 当たり判定・at_locator から実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_l/attack_l

# デバッグ用
    # function api:bounding/cuboid_preview.m {Uid:1004,AttackName:"Spear.Left",\
...
# 攻撃実行
    function mhdp_monsters:core/util/tick/event/apply_attack.m {Uid:1004,AttackName:"Spear.Left",\
        Player_Selector:"@a[tag=Ply.State.EnableDamage,distance=..30]",\
            Player_Offset_X:0.0,Player_Offset_Y:0.0,Player_Offset_Z:0.0,\
            Player_Scale_X:3.5,Player_Scale_Y:3.5,Player_Scale_Z:3.5,\
        Entity_Selector:"@e[type=slime,tag=Entity.EnableDamage,tag=!Mns.HitBox.Valk,distance=..30]",\
