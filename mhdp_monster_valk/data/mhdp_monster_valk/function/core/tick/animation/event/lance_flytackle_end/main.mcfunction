...
# 演出
    execute if score @s aj.lance_flytackle_end.frame matches 2..8 run particle dust{color:[1.000,0.112,0.312],scale:4} ^ ^2 ^-3 0.5 0.5 0.5 0.15 3
    execute if score @s aj.lance_flytackle_end.frame matches 2..8 run particle dust{color:[1.000,0.112,0.312],scale:4} ^ ^2 ^-2 0.5 0.5 0.5 0.15 3
