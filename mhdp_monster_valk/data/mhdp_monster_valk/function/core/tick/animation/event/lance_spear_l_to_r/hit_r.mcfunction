#> mhdp_monster_valk:core/tick/animation/event/lance_spear_l_to_r/hit_r
#
# アニメーションイベントハンドラ 2連突き (右翼爪 当たり判定・at_locator から実行)
#
# @within function mhdp_monster_valk:core/tick/animation/event/lance_spear_l_to_r/attack_r
