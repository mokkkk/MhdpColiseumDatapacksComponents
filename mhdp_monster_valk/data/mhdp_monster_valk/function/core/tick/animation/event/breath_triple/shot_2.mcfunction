...
# 初期化
    execute as @n[type=item_display,tag=Mns.Shot.Dino.Breath,tag=Start] positioned as @s facing entity @n[type=area_effect_cloud,tag=Mns.ShotPos.Dino.2] feet run tp @s ~ ~ ~ ~ ~
