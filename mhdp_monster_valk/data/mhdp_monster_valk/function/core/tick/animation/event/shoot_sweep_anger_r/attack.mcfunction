...
# データ読み込み
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:monster_data AttackData[{Uid:1004}].Attacks[{Name:"Sweep.Anger"}]
...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_r/m.attack with entity @s data.locators.pos_wing_r_1
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_r/m.attack with entity @s data.locators.pos_wing_r_2
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_r/m.attack with entity @s data.locators.pos_wing_r_3
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_r/m.attack with entity @s data.locators.pos_wing_r_4
