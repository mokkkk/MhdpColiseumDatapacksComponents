...
# 軸合わせ
    ...
    execute if score @s aj.lance_spear_r_to_l.frame matches 11 run function mhdp_monster_valk:core/tick/animation/event/lance_spear_r_to_l/turn_start_adjust
    ...
    execute if score @s aj.lance_spear_r_to_l.frame matches 44 run function mhdp_monster_valk:core/tick/animation/event/lance_spear_r_to_l/turn_start_adjust
