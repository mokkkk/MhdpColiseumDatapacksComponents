...
# 軸合わせ
    execute if score @s aj.shoot_sweep_anger_l.frame matches 2 run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_l/turn_start
    execute if score @s aj.shoot_sweep_anger_l.frame matches 11 run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_l/turn_start
    execute if score @s aj.shoot_sweep_anger_l.frame matches 2..20 run function mhdp_monsters:core/util/other/turn_to_target_rotate
