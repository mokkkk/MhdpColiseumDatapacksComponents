...
# 2連
    execute if score @s aj.lance_vertical_l.frame matches 65 run function animated_java:valk_aj/animations/lance_vertical_l_to_r/tween {duration:1, to_frame: 1}
