...
# 演出
    execute if score @s aj.lance_vertical_l_to_r.frame matches 11 positioned ^2 ^1 ^-6 run particle flash{color:[1.000,0.200,0.200,1.00]} ~ ~1 ~ 3 3 3 0 20 force @a[distance=..48]
