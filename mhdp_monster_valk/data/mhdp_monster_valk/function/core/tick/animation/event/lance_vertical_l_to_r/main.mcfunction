...
# 移動
    ...
    execute if score @s aj.lance_vertical_l_to_r.frame matches 52..62 at @s run tp @s ^ ^ ^-0.2
    execute if score @s aj.lance_vertical_l_to_r.frame matches 63..68 at @s run tp @s ^ ^ ^-0.1
