...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_l/m.attack with entity @s data.locators.pos_wing_l_1
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_l/m.attack with entity @s data.locators.pos_wing_l_2
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_l/m.attack with entity @s data.locators.pos_wing_l_3
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/shoot_sweep_anger_l/m.attack with entity @s data.locators.pos_wing_l_4
