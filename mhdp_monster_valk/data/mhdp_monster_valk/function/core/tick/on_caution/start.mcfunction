#> mhdp_monster_valk:core/tick/on_caution/start
#
# tick処理 警戒中 開始
#
# @within function mhdp_monster_valk:core/tick/on_relax/tick
...
# ボスバー名更新
    function mhdp_monsters:core/util/tick/update_bossbar.m {Monster:"valk",State:"caution"}
