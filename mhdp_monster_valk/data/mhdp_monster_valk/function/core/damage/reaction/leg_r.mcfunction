...
# アニメーション再生処理
    ...
    # アニメーション再生
            execute if score @s Mns.Valk.LegR.Damage.Count matches ..2 run function animated_java:valk_aj/animations/lance_damage_body_r/tween {duration:1, to_frame: 0}
            execute if score @s Mns.Valk.LegR.Damage.Count matches 3.. run function animated_java:valk_aj/animations/lance_damage_down_r/tween {duration:1, to_frame: 0}
