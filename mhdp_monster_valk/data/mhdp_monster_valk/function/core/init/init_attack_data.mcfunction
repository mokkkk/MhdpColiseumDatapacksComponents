...
# 突き
    data modify storage mhdp_core:monster_data AttackData[{Uid:1004}].Attacks append value {Name:"Spear",DamageValue:8.0f,GuardValue:4,ElementType:5,ElementMultiply:10,Knockback:2,IsLaunch:true,LaunchType:2,IsDisableDefence:false,IsDisableDamageInterval:false,IsDisableGuts:false}
...
# 翼槍叩きつけ
    ...
    data modify storage mhdp_core:monster_data AttackData[{Uid:1004}].Attacks append value {Name:"Vertical",DamageValue:10.0f,GuardValue:6,ElementType:0,ElementMultiply:0,Knockback:2,IsLaunch:false,LaunchType:1,IsDisableDefence:false,IsDisableDamageInterval:false,IsDisableGuts:false}
