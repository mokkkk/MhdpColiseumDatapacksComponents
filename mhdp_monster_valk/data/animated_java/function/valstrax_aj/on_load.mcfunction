...
execute as @e[type=item_display,tag=aj.valstrax_aj.root] unless score @s aj.is_rig_loaded matches 1 at @s run function animated_java:valstrax_aj/root/on_load