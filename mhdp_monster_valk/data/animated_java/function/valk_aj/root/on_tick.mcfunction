...
execute if entity @s[tag=aj.valk_aj.animation.shoot_bomb_side3.playing] run function animated_java:valk_aj/animations/shoot_bomb_side3/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_bomb_side2.playing] run function animated_java:valk_aj/animations/shoot_bomb_side2/zzz/on_tick
...
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault5.playing] run function animated_java:valk_aj/animations/shoot_sault5/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault4.playing] run function animated_java:valk_aj/animations/shoot_sault4/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault_1.playing] run function animated_java:valk_aj/animations/shoot_sault_1/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault_test.playing] run function animated_java:valk_aj/animations/shoot_sault_test/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault_z_rotation.playing] run function animated_java:valk_aj/animations/shoot_sault_z_rotation/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault6.playing] run function animated_java:valk_aj/animations/shoot_sault6/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_move_to_sault_sample.playing] run function animated_java:valk_aj/animations/shoot_move_to_sault_sample/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault3.playing] run function animated_java:valk_aj/animations/shoot_sault3/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.shoot_sault2.playing] run function animated_java:valk_aj/animations/shoot_sault2/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.lance_tackle3.playing] run function animated_java:valk_aj/animations/lance_tackle3/zzz/on_tick
