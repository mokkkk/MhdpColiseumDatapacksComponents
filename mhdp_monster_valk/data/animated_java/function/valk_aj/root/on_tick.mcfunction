...
execute if entity @s[tag=aj.valk_aj.animation.comet_phase_1_2.playing] run function animated_java:valk_aj/animations/comet_phase_1_2/zzz/on_tick
...
execute if entity @s[tag=aj.valk_aj.animation.comet_4.playing] run function animated_java:valk_aj/animations/comet_4/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.comet_3.playing] run function animated_java:valk_aj/animations/comet_3/zzz/on_tick
execute if entity @s[tag=aj.valk_aj.animation.comet_2.playing] run function animated_java:valk_aj/animations/comet_2/zzz/on_tick
