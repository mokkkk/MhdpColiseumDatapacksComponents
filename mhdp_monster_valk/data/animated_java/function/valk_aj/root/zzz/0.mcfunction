...
function animated_java:valk_aj/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '587fda51cb1d8c31b3224330f2a11e8c99a2db35daed5e3bb407c2bde10a16aa'
