...
tag @s add animated_java_valk.valk.animation.shoot_to_lance.playing
...
execute at @s run function animated_java_valk:valk/animations/shoot_to_lance/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java_valk:valk/animations/shoot_to_lance/zzz/apply_frame {frame: $(to_frame)}
