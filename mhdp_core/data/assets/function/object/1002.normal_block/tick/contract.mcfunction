#> assets:object/1002.normal_block/tick/contract
#
# tick処理
...
# 縮小
    execute as @e[type=item_display,tag=Asset.Build.Target] run function assets:core/object/build/contract_model.m {TX:0f,TY:-2f,TZ:0f,SX:0.0f,SY:0.0f,SZ:0.0f}
