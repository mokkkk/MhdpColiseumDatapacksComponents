...
# 演出
    execute if score @s ObjectTick matches ..14 at @n[tag=Temp.Victim] facing entity @p[tag=11.TargetPlayer] eyes run function assets:object/0011.spirit_release_slash/tick/vfx_start
