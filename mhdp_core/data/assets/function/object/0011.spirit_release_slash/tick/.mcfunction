...
# 攻撃
    ...
    execute if score @s ObjectTick matches 19 run function assets:object/0011.spirit_release_slash/tick/attack
    execute if score @s ObjectTick matches 20 run function assets:object/0011.spirit_release_slash/tick/attack
    execute if score @s ObjectTick matches 21 run function assets:object/0011.spirit_release_slash/tick/attack
    execute if score @s ObjectTick matches 22 run function assets:object/0011.spirit_release_slash/tick/attack
    execute if score @s ObjectTick matches 23 run function assets:object/0011.spirit_release_slash/tick/attack
    execute if score @s ObjectTick matches 24 run function assets:object/0011.spirit_release_slash/tick/attack
    execute if score @s ObjectTick matches 25 run function assets:object/0011.spirit_release_slash/tick/attack
