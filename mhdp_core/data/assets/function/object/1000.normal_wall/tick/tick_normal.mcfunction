#> assets:object/1000.normal_wall/tick/tick_normal
#
# tick処理
...
# 消去
    execute if score @s ObjectTick >= @s Build.Stats.RemainingTime run function assets:object/1000.normal_wall/is_broken/
