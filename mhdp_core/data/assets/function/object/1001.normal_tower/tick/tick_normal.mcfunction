#> assets:object/1001.normal_tower/tick/tick_normal
#
# tick処理
...
# 消去
    execute if score @s ObjectTick >= @s Build.Stats.RemainingTime run function assets:object/1001.normal_tower/is_broken/
