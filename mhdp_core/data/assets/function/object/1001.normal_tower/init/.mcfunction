...
# 見た目召喚
    execute positioned as @s run summon item_display ~ ~ ~ {interpolation_duration:3,teleport_duration:0,Tags:["Asset.Build.Display","Asset.Build.Display.A","Asset.Build.Display.Init"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,0f]},item:{id:"minecraft:stone",count:1,components:{"minecraft:item_model":"builds/wall_normal"}}}
    execute positioned as @s run summon item_display ~ ~ ~ {interpolation_duration:3,teleport_duration:0,Tags:["Asset.Build.Display","Asset.Build.Display.B","Asset.Build.Display.Init"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,0f]},item:{id:"minecraft:stone",count:1,components:{"minecraft:item_model":"builds/wall_normal"}}}
    execute positioned as @s run summon item_display ~ ~ ~ {interpolation_duration:3,teleport_duration:0,Tags:["Asset.Build.Display","Asset.Build.Display.C","Asset.Build.Display.Init"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,0f]},item:{id:"minecraft:stone",count:1,components:{"minecraft:item_model":"builds/wall_normal"}}}
# 紐づけ開始
