#> assets:object/0001.normal_arrow/tick/attack_tec_horming
#
# 矢の処理
#
# @within function assets:object/0001.normal_arrow/tick/attack_tec

# モーション値上昇
    execute store result score #mhdp_temp_attack_value_strong MhdpCore run data get storage api: Arg.DamageMult 100
    scoreboard players operation #mhdp_temp_attack_value_strong MhdpCore *= #const_bow_horming_multiply Const
