#> assets:object/0001.normal_arrow/tick/attack
#
# 矢の召喚処理
#
...
# 攻撃主を取得
    ...
    execute as @a if score @s Ply.Uid = #mhdp_temp_target_player_uid Ply.Uid run tag @s add 1.TargetPlayer
