#> assets:object/10044.valk_comet_star/tick/
#
...
# frame 送り（0→1→2 を繰り返す）
    execute if score @s MhdpCore matches ..1 run data modify entity @s text set value {"text":"0","font":"vfx/valstrax/star"}
    execute if score @s MhdpCore matches 2 run data modify entity @s text set value {"text":"1","font":"vfx/valstrax/star"}
