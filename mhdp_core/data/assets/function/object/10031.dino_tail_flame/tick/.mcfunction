#> assets:object/10031.dino_tail_flame/tick/
#
# オブジェクトのtick処理
#
...
# 着弾
    execute at @s as @n[type=item_display,tag=Mns.Root.Dino] run function assets:object/10031.dino_tail_flame/tick/attack
