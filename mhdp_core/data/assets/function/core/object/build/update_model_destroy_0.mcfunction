#> assets:core/object/build/update_model_destroy_0
#
# モデル更新
...
# モデル更新
    execute as @e[type=item_display,tag=Asset.Build.Target] run data modify entity @s item.components."minecraft:custom_model_data" set value {strings:["destroy_0"]}

# スコア更新
    scoreboard players set @s Build.Stats.DestroyLevel 1
