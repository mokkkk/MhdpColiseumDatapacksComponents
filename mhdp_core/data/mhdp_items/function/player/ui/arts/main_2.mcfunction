...
# UI設定
    ...
    execute if entity @s[tag=Ply.Weapon.UsingArts.2] if score #mhdp_temp_arts MhdpCore matches 1.. run data modify storage mhdp_core:temp UI.ArtsArray2 append value [{"text":"2","font":"ui/new_player_ui/arts/gauge","shadow_color":[0,0,0,0]},{"text": "\uF801","font": "space"}]
    ...
    execute if entity @s[tag=Ply.Weapon.UsingArts.2] if score #mhdp_temp_arts MhdpCore matches 100.. run data modify storage mhdp_core:temp UI.ArtsArray2 append value [{"text":"2","font":"ui/new_player_ui/arts/gauge","shadow_color":[0,0,0,0]},{"text": "\uF801","font": "space"}]
    scoreboard players operation #mhdp_temp_arts MhdpCore -= #const_100 Const
