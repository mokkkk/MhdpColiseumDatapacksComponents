...
# UI設定
    ...
    execute if score #mhdp_temp_arts MhdpCore matches 1.. run data modify storage mhdp_core:temp UI.ArtsArray1 append value [{"text":"1","font":"ui/new_player_ui/arts/gauge","shadow_color":[0,0,0,0]},{"text": "\uF801","font": "space"}]
    ...
    execute if score #mhdp_temp_arts MhdpCore matches 100.. run data modify storage mhdp_core:temp UI.ArtsArray1 append value [{"text":"1","font":"ui/new_player_ui/arts/gauge","shadow_color":[0,0,0,0]},{"text": "\uF801","font": "space"}]
    scoreboard players operation #mhdp_temp_arts MhdpCore -= #const_100 Const
...
# # 表示
#     execute if entity @s[tag=!Ply.Weapon.UsingArts.1] run data modify storage mhdp_core:temp UI.Arts1 set value [{"interpret":true,"nbt":"UI.ArtsArray1[0]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[1]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[2]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[3]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[4]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[5]","storage":"mhdp_core:temp"},{"text":"\uF814\uF801","font": "space"},{"text":"_","font":"ui/arts_1","color":"white"}]
#     execute if entity @s[tag=Ply.Weapon.UsingArts.1] run data modify storage mhdp_core:temp UI.Arts1 set value [{"interpret":true,"nbt":"UI.ArtsArray1[0]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[1]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[2]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[3]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[4]","storage":"mhdp_core:temp"},{"interpret":true,"nbt":"UI.ArtsArray1[5]","storage":"mhdp_core:temp"},{"text":"\uF814\uF801","font": "space"},{"text":"=","font":"ui/arts_1","color":"white"}]
