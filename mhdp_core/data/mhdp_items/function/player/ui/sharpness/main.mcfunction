...
# UI設定
    ...
    execute if entity @s[tag=!Ply.Flag.HideSharpness] run data modify storage mhdp_core:temp UI.Sharpness set value ["",{"score":{"name":"#mhdp_temp_sharpness","objective":"MhdpCore"},"font":"ui/new_player_ui/sharpness","shadow_color":[0,0,0,0]}]
