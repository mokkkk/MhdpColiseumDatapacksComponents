...
# 移動速度減少
    execute if entity @s[tag=Ply.Ope.IsSprinting] run attribute @s movement_speed modifier add mhdp_core:stamina_movement_speed -0.023 add_value
    execute if entity @s[tag=!Ply.Ope.IsSprinting] run attribute @s movement_speed modifier remove mhdp_core:stamina_movement_speed
