...
# 自然回復
    execute if entity @s[tag=!Skill.Stamina.StaminaSurge.1,tag=!Skill.Stamina.StaminaSurge.2,tag=!Ply.Ope.IsSprinting,tag=!Ply.Weapon.StaminaNotRegen,tag=!Ply.Weapon.StaminaEmpty,tag=!Ply.Ope.IsAir] if score @s Ply.Stats.Stamina matches ..999 if score @s Ply.Timer.VectorJumpCoolTime matches ..0 run scoreboard players add @s Ply.Stats.Stamina 5
    execute if entity @s[tag=Skill.Stamina.StaminaSurge.1,tag=!Ply.Ope.IsSprinting,tag=!Ply.Weapon.StaminaNotRegen,tag=!Ply.Weapon.StaminaEmpty,tag=!Ply.Ope.IsAir] if score @s Ply.Stats.Stamina matches ..999 if score @s Ply.Timer.VectorJumpCoolTime matches ..0 run scoreboard players add @s Ply.Stats.Stamina 7
    execute if entity @s[tag=Skill.Stamina.StaminaSurge.2,tag=!Ply.Ope.IsSprinting,tag=!Ply.Weapon.StaminaNotRegen,tag=!Ply.Weapon.StaminaEmpty,tag=!Ply.Ope.IsAir] if score @s Ply.Stats.Stamina matches ..999 if score @s Ply.Timer.VectorJumpCoolTime matches ..0 run scoreboard players add @s Ply.Stats.Stamina 9
