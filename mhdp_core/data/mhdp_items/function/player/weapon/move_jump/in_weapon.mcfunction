#> mhdp_items:player/weapon/move_jump/in_weapon
#
# 移動ジャンプ
#
# @within function mhdp_items:weapons/**
...
# 移動
    execute rotated ~ -25 run function api:weapon_operation/vector_move.m {Strength:8000}
    data modify storage mhdp_core:temp PlayerData.VectorMove.Strength set value 800
