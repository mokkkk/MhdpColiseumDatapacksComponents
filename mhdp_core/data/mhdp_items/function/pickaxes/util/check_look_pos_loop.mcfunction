...
# 処理
    ...
    execute unless block ^ ^ ^0.5 #mhdp_core:no_collision align xyz positioned ~0.5 ~0.5 ~0.5 run return run function mhdp_items:pickaxes/util/execute_command.m with storage api: Arg
