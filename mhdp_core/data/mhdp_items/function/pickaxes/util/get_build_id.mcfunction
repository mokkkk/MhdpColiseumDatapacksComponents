...
# 地上・スニーク
    execute if entity @s[tag=Ply.Ope.IsSneaking] run data modify storage mhdp_core:temp Arg.ObjectId set from storage mhdp_core:temp PlayerData.Item.Mainhand.components."minecraft:custom_data".Build2
