...
# 通知
    ...
    execute if score @n[type=item_display,tag=Itm.Root.Nikuyaki.Target] MhdpCore matches 170..179 at @n[type=item_display,tag=Itm.Root.Nikuyaki.Target] run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0 0 0 0 1
