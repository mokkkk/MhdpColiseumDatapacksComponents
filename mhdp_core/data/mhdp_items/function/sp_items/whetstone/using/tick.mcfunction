...
# 使用中断
    ...
    execute if score @s Itm.Whetstone.GeneralTimer matches 1.. if entity @s[tag=Ply.Ope.StartKeyJump] run function mhdp_items:sp_items/whetstone/util/interrupt
