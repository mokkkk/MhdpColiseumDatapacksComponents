...
# アニメーション演出
    ...
    # アニメーション・引き絞り
        execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:weapons/bow/type_tec/12_targetting_shot/animation_0
    ...
    # アニメーション・射撃
        ...
        execute if score @s Wpn.GeneralTimer matches 27 run function mhdp_items:weapons/bow/type_tec/12_targetting_shot/animation_6
