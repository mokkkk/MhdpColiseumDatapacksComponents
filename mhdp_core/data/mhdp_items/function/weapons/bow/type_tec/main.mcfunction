...
# ビン装填
    # 開始：スニーク+右クリック短押し
        execute if entity @s[tag=Ply.Ope.UsedEnderEye.Short,tag=Ply.Weapon.NoOpe,tag=Ply.Ope.IsSneaking] if score @s Wpn.Bw.Gauge matches 100.. run function mhdp_items:weapons/bow/type_tec/9_equip_bottle/start
    # 処理
