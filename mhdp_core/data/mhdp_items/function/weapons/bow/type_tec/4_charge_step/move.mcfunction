...
# 移動
    ...
    execute if entity @s[tag=Ply.Ope.IsKeyBack,tag=Ply.Ope.IsKeyLeft] rotated ~-135 ~ run return run function api:weapon_operation/use_player_motion.m {Strength:4000, IsForce:true, IsAdjust:false}
    execute if entity @s[tag=Ply.Ope.IsKeyBack,tag=Ply.Ope.IsKeyRight] rotated ~135 ~ run return run function api:weapon_operation/use_player_motion.m {Strength:4000, IsForce:true, IsAdjust:false}
    ...
    execute if entity @s[tag=Ply.Ope.IsKeyBack,tag=!Ply.Ope.IsKeyLeft,tag=!Ply.Ope.IsKeyRight] rotated ~180 ~ run return run function api:weapon_operation/use_player_motion.m {Strength:4000, IsForce:true, IsAdjust:false}
