...
# アニメーション演出
    ...
    execute if score @s Wpn.GeneralTimer matches 44 run playsound item.crossbow.shoot master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 0.9
    execute if score @s Wpn.GeneralTimer matches 44 run playsound item.crossbow.shoot master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.1
    execute if score @s Wpn.GeneralTimer matches 44 run playsound item.crossbow.shoot master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 0.7
    execute if score @s Wpn.GeneralTimer matches 44 run playsound entity.arrow.shoot master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.2
    execute if score @s Wpn.GeneralTimer matches 44 run playsound entity.arrow.shoot master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.2
    execute if score @s Wpn.GeneralTimer matches 44 run playsound entity.firework_rocket.launch master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.2
    execute if score @s Wpn.GeneralTimer matches 44 run playsound entity.firework_rocket.launch master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1
    ...
    execute if score @s Wpn.GeneralTimer matches 44 run function mhdp_items:weapons/bow/type_tec/6_shot_pierce/animation_4
    execute if score @s Wpn.GeneralTimer matches 45 run function mhdp_items:weapons/bow/type_tec/6_shot_pierce/animation_5
    execute if score @s Wpn.GeneralTimer matches 46 run function mhdp_items:weapons/bow/type_tec/6_shot_pierce/animation_6
    execute if score @s Wpn.GeneralTimer matches 48 run function mhdp_items:weapons/bow/type_tec/6_shot_pierce/animation_7

# 攻撃
    execute if score @s Wpn.GeneralTimer matches 44 positioned ~ ~1.65 ~ run function mhdp_items:weapons/bow/type_tec/6_shot_pierce/attack
...
# 移動
    execute if score @s Wpn.GeneralTimer matches 44 run tp @s @s
    execute if score @s Wpn.GeneralTimer matches 44 run scoreboard players set $strength delta.api.launch 4000
    execute if score @s Wpn.GeneralTimer matches 44 rotated ~180 0 run function delta:api/launch_looking

# スタミナ消費
    execute if score @s Wpn.GeneralTimer matches 44 run scoreboard players remove @s Ply.Stats.Stamina 100
