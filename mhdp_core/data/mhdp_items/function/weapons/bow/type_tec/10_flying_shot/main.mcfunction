...
# タイマー増加
    ...
    execute if entity @s[tag=!Ply.Ope.IsUsingEnderEye] if score @s Wpn.GeneralTimer matches 5..9 run scoreboard players add @s Wpn.GeneralTimer 1
...
# アニメーション演出
    ...
    execute if score @s Wpn.GeneralTimer matches 6 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_4
    execute if score @s Wpn.GeneralTimer matches 7 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_5
    execute if score @s Wpn.GeneralTimer matches 8 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_6
    execute if score @s Wpn.GeneralTimer matches 9 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_7
