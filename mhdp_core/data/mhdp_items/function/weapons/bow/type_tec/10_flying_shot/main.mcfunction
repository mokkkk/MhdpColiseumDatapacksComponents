...
# アニメーション演出
    ...
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_0
    execute if score @s Wpn.GeneralTimer matches 2 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_1
    execute if score @s Wpn.GeneralTimer matches 3 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_2
    execute if score @s Wpn.GeneralTimer matches 4 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_3
    execute if score @s Wpn.GeneralTimer matches 7 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_4
    execute if score @s Wpn.GeneralTimer matches 8 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_5
    execute if score @s Wpn.GeneralTimer matches 9 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_6
    execute if score @s Wpn.GeneralTimer matches 10 run function mhdp_items:weapons/bow/type_tec/10_flying_shot/animation_7

# 攻撃
    execute if score @s Wpn.GeneralTimer matches 7 if score @s Wpn.Bw.FlyingShot.Count matches ..2 positioned ~ ~1.65 ~ run function mhdp_items:weapons/bow/type_tec/10_flying_shot/attack
