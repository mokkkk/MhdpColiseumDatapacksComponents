...
# 移動
    ...
    execute if score @s Wpn.GeneralTimer matches 8 rotated ~180 0 run function api:weapon_operation/use_player_motion.m {Strength:3000, IsForce:false, IsAdjust:false}
