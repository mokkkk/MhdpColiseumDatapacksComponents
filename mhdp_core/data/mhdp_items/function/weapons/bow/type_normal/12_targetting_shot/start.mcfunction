#> mhdp_items:weapons/bow/type_normal/12_targetting_shot/start
#
# 昇天煌弓・箭雨 開始
#
...
# タグ付与
    tag @s add Wpn.Bw.Normal.TargettingShot
...
# 操作表示
    function mhdp_items:core/util/item_modify_custom_name {Name:"昇天煌弓・箭雨"}
