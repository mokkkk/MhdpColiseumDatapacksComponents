#> mhdp_items:weapons/bow/type_normal/9_equip_bottle/equip
#
# ビン装填
#
...
# ゲージが残っており、ビン装填の余裕がある場合、繰り返す
    execute if score @s Wpn.Bw.Gauge matches 13.. if score @s Wpn.Bw.Bottle.Count matches ..7 run function mhdp_items:weapons/bow/type_normal/9_equip_bottle/equip
