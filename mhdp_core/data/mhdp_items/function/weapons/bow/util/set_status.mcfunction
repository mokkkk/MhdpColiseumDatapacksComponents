...
# ステータス設定
    ...
    attribute @s generic.attack_speed modifier add mhdp_core:weapon_attack_speed 0 add_value
    ...
    attribute @s generic.attack_damage modifier add mhdp_core:weapon_attack_damage -0.5 add_value
