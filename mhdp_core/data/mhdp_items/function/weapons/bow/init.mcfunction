...
# 天の型
    ...
    data modify storage mhdp_core:game_data WeaponAttackData.Bow.Tec.Shot.2 set value {AttackType:Shot,DamageMult:6,PartDamageMult:100,ElementDamageMult:70,StunValue:0,TireValue:2,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:true,VfxRotation:-0.1,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
    ...
    data modify storage mhdp_core:game_data WeaponAttackData.Bow.Tec.Shot.4 set value {AttackType:Shot,DamageMult:9,PartDamageMult:100,ElementDamageMult:100,StunValue:0,TireValue:2,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:true,VfxRotation:-0.1,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
    ...
    data modify storage mhdp_core:game_data WeaponAttackData.Bow.Tec.Shot.2.Crit set value {AttackType:Shot,DamageMult:12,PartDamageMult:100,ElementDamageMult:100,StunValue:0,TireValue:2,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:true,VfxRotation:-0.1,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
    ...
    data modify storage mhdp_core:game_data WeaponAttackData.Bow.Tec.Shot.4.Crit set value {AttackType:Shot,DamageMult:19,PartDamageMult:100,ElementDamageMult:135,StunValue:0,TireValue:2,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:true,VfxRotation:-0.1,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
    ...
    data modify storage mhdp_core:game_data WeaponAttackData.Bow.Tec.Horming.Burst set value {AttackType:Blow,DamageMult:45,PartDamageMult:100,ElementDamageMult:0,StunValue:25,TireValue:2,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:false,VfxRotation:-0.1,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
