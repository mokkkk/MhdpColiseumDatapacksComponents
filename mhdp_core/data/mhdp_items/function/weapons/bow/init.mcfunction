...
# 天の型
    ...
    data modify storage mhdp_core:game_data WeaponAttackData.Bow.Tec.Horming.Burst set value {AttackType:Shot,DamageMult:45,PartDamageMult:100,ElementDamageMult:0,StunValue:0,TireValue:2,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:false,VfxRotation:-0.1,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
