...
# 終了
    execute if entity @s[tag=!Death] unless block ^ ^ ^ #mhdp_core:no_collision run kill @s
    execute if entity @s[tag=!Death] if score @s Mns.Shot.Timer matches 20.. run kill @s
