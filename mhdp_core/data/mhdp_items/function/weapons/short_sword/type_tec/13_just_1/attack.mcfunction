#> mhdp_items:weapons/short_sword/type_tec/13_just_1/attack
#
# 飛び込み斬り 攻撃判定
#
# @within function mhdp_items:weapons/great_sword/type_tec/13_just_1/change_to_chargeattack
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Just.1
