#> mhdp_items:weapons/short_sword/type_tec/19_moveslash/attack
#
# 突進斬り 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.MoveSlash
