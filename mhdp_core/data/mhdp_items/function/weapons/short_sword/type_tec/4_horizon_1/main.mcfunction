...
# 先行入力
    ...
    execute if entity @s[tag=Ply.Ope.StartKeyJump,tag=!Ply.Ope.IsKeySprint] if score @s Wpn.GeneralTimer matches 2..13 run function mhdp_items:core/buffering/jump
