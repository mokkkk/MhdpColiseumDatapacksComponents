#> mhdp_items:weapons/short_sword/type_tec/4_horizon_1/attack
#
# 水平斬りコンボ1 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Horizon.1
