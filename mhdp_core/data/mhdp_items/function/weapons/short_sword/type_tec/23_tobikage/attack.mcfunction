#> mhdp_items:weapons/short_sword/type_tec/23_tobikage/attack
#
# 飛影 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Normal.1
