#> mhdp_items:weapons/short_sword/type_tec/25_just_counter/main
#
# カウンター斬り メイン処理
#
...
# 移動
    ...
    execute if score @s Wpn.GeneralTimer matches 2 run scoreboard players set $strength delta.api.launch 12000
