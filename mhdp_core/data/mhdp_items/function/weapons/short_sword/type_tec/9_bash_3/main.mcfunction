...
# 遷移
    # スニーク＋右クリック：バックナックルに移行
        # execute if entity @s[tag=Ply.Ope.Buffering.A] if score @s Wpn.GeneralTimer matches 9.. run function mhdp_items:weapons/short_sword/type_tec/9_bash_3/change_to_bash_2
