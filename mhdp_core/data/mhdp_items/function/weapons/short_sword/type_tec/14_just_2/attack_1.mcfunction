...
# 攻撃
    execute if entity @s[tag=!Ply.Flag.Just.Success] run data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Just.2.1
    execute if entity @s[tag=Ply.Flag.Just.Success] run data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Just.2.1.S
