...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.short_sword.action.charged_plunge_finish"}
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 31 run function mhdp_items:weapons/short_sword/type_tec/27_charge_spear/animation_7
