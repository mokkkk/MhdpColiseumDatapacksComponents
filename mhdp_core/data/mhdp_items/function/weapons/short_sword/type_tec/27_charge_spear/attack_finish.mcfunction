#> mhdp_items:weapons/short_sword/type_tec/27_charge_spear/attack_finish
#
# 溜め斬り落とし 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.ChargeSpear.Spear.Finish
