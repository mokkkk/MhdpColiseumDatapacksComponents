#> mhdp_items:weapons/short_sword/type_tec/27_charge_spear/main
#
# 溜め斬り落とし メイン処理
#
...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.short_sword.action.charged_plunge"}
...
# 攻撃
    execute if entity @s[tag=!Ply.Flag.Hit] if score @s Wpn.GeneralTimer matches 27..30 run function mhdp_items:weapons/short_sword/type_tec/27_charge_spear/attack_move
    execute if entity @s[tag=Ply.Flag.Hit] if score @s Wpn.GeneralTimer matches 31 run tag @s remove Ply.Flag.Hit
    execute if score @s Wpn.GeneralTimer matches 32 run function mhdp_items:weapons/short_sword/type_tec/27_charge_spear/attack
...
# 遷移
    ...
    # ヒット時
        execute if entity @s[tag=Ply.Flag.Hit] if score @s Wpn.GeneralTimer matches 32 run function mhdp_items:weapons/short_sword/type_tec/27_charge_spear/change_to_hit
