...
# アニメーション演出
    ...
    # execute if score @s Wpn.AnimationTimer matches 4 run function mhdp_items:weapons/short_sword/type_tec/19_moveslash/animation_1
    # execute if score @s Wpn.AnimationTimer matches 5 run function mhdp_items:weapons/short_sword/type_tec/19_moveslash/animation_2
    # execute if score @s Wpn.AnimationTimer matches 6 run function mhdp_items:weapons/short_sword/type_tec/19_moveslash/animation_3
    ...
    # execute if score @s Wpn.AnimationTimer matches 10 run function mhdp_items:weapons/short_sword/type_tec/6_horizon_3/animation_5
    # execute if score @s Wpn.AnimationTimer matches 11 run function mhdp_items:weapons/short_sword/type_tec/6_horizon_3/animation_6
    # execute if score @s Wpn.AnimationTimer matches 13 run function mhdp_items:weapons/short_sword/type_tec/6_horizon_3/animation_7

    # execute if score @s Wpn.AnimationTimer matches 15 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_5
    # execute if score @s Wpn.AnimationTimer matches 16 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_6
    # execute if score @s Wpn.AnimationTimer matches 18 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_7
    # execute if score @s Wpn.AnimationTimer matches 20 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_8
    # execute if score @s Wpn.AnimationTimer matches 21 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_9
    # execute if score @s Wpn.AnimationTimer matches 22 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_10
    # execute if score @s Wpn.AnimationTimer matches 23 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_11
    # execute if score @s Wpn.AnimationTimer matches 24 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_12
    # execute if score @s Wpn.AnimationTimer matches 26 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_13

    # execute if score @s Wpn.AnimationTimer matches 28 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/animation_0
    # execute if score @s Wpn.AnimationTimer matches 29 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/animation_1
    # execute if score @s Wpn.AnimationTimer matches 30 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/animation_2
    # execute if score @s Wpn.AnimationTimer matches 31 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/animation_3
    
    # execute if score @s Wpn.AnimationTimer matches 34 run function mhdp_items:weapons/short_sword/type_tec/13_just_1/animation_0
    # execute if score @s Wpn.AnimationTimer matches 35 run function mhdp_items:weapons/short_sword/type_tec/13_just_1/animation_1
    # execute if score @s Wpn.AnimationTimer matches 36 run function mhdp_items:weapons/short_sword/type_tec/13_just_1/animation_2
    # execute if score @s Wpn.AnimationTimer matches 37 run function mhdp_items:weapons/short_sword/type_tec/13_just_1/animation_3

    # execute if score @s Wpn.AnimationTimer matches 40 run function mhdp_items:weapons/short_sword/type_tec/16_just_4/animation_0
    # execute if score @s Wpn.AnimationTimer matches 43 run function mhdp_items:weapons/short_sword/type_tec/16_just_4/animation_1
    # execute if score @s Wpn.AnimationTimer matches 44 run function mhdp_items:weapons/short_sword/type_tec/16_just_4/animation_2

    # execute if score @s Wpn.AnimationTimer matches 50 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_11
    # execute if score @s Wpn.AnimationTimer matches 55 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_12
    # execute if score @s Wpn.AnimationTimer matches 57 run function mhdp_items:weapons/short_sword/type_tec/14_just_2/animation_13
    # execute if score @s Wpn.AnimationTimer matches 58 run function mhdp_items:weapons/short_sword/type_tec/6_horizon_3/animation_7
...
# 演出
    ...
    execute if entity @s[tag=!Ply.Option.DisableCameraEffect] if score @s Wpn.GeneralTimer matches 55..58 at @s run tp @s ~ ~ ~ ~4 ~1
...
# 移動
    execute if score @s Wpn.GeneralTimer matches 42 run tp @s @s
