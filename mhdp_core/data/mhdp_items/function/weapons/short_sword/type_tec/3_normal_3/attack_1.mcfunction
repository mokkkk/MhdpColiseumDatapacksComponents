#> mhdp_items:weapons/short_sword/type_tec/2_normal_2/attack_1
#
# 通常コンボ3 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Normal.3.1
