...
# 攻撃
    execute unless entity @s[tag=Ply.Ope.IsKeyRight] run data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Normal.3.2
    execute if entity @s[tag=Ply.Ope.IsKeyRight] run data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Normal.3.2.Right
