...
# 天の型
    ...
    # 通常コンボ
        ...
        data modify storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Normal.3.1 set value {AttackType:"Blow",DamageMult:30,PartDamageMult:100,ElementDamageMult:120,StunValue:5,TireValue:10,DragonAuraValue:0,IsDecreseSharpness:false,IsShowVfx:true,VfxRotation:0,IsVfxStrong:false,VfxScale:[3f,3f,3f]}
