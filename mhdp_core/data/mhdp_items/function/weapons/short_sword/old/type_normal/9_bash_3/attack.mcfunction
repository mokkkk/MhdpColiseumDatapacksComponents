#> mhdp_items:weapons/short_sword/type_normal/9_bash_3/attack
#
# 水平斬りコンボ3 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Normal.Bash.3
