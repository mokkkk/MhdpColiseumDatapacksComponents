...
# 演出
    ...
    execute if score @s Wpn.Ss.ChargeTimer matches 260.. if score @s Wpn.Ss.ChargeCount matches ..1 run function mhdp_items:weapons/short_sword/type_normal/10_charge/up_charge_count
    execute if score @s Wpn.Ss.ChargeTimer matches 400.. if score @s Wpn.Ss.ChargeCount matches ..2 run function mhdp_items:weapons/short_sword/type_normal/10_charge/up_charge_count
...
# 遷移
    ...
    # 溜め2：剣盾ラッシュに移行
        execute if entity @s[tag=!Ply.Ope.IsUsingEnderEye] if score @s Wpn.GeneralTimer matches 15.. if score @s Wpn.Ss.ChargeCount matches 2 run function mhdp_items:weapons/short_sword/type_normal/10_charge/change_to_rush
    # 溜め3：剣の舞に移行
        execute if entity @s[tag=!Ply.Ope.IsUsingEnderEye] if score @s Wpn.GeneralTimer matches 15.. if score @s Wpn.Ss.ChargeCount matches 3.. run function mhdp_items:weapons/short_sword/type_normal/10_charge/change_to_dance_rush
