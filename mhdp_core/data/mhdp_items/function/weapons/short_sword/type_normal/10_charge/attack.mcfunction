#> mhdp_items:weapons/short_sword/type_normal/1_sword_1/attack
#
# 剣コンボ1 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Normal.Sword.1
