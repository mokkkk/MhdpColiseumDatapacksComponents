#> mhdp_items:weapons/short_sword/type_normal/30_upper_bash/main
#
# 滅・昇竜撃 メイン処理
#
...
# アニメーション演出
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/animation_0
    execute if score @s Wpn.GeneralTimer matches 9 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/animation_1
    execute if score @s Wpn.GeneralTimer matches 11 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/animation_2
    execute if score @s Wpn.GeneralTimer matches 13 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/animation_3
    execute if score @s Wpn.GeneralTimer matches 15 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/animation_4
    execute if score @s Wpn.GeneralTimer matches 18 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/animation_5

# 攻撃
    execute if score @s Wpn.GeneralTimer matches 9 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/attack
    execute if entity @s[tag=Ply.Flag.Hit,tag=Ply.Flag.Ss.UpperBashCounter] if score @s Wpn.GeneralTimer matches 18 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/attack_pursuit
    execute if entity @s[tag=Ply.Flag.Hit,tag=Ply.Flag.Ss.UpperBashCounter] if score @s Wpn.GeneralTimer matches 21 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/attack_pursuit
    execute if entity @s[tag=Ply.Flag.Hit,tag=Ply.Flag.Ss.UpperBashCounter] if score @s Wpn.GeneralTimer matches 24 run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/attack_pursuit
...
# 遷移
    # 右クリック：強フォールバッシュに移行
        execute if entity @s[tag=Ply.Ope.Buffering.A,tag=!Ply.Flag.Ss.UpperBashCounter] if score @s Wpn.GeneralTimer matches 20..34 run function mhdp_items:weapons/short_sword/type_normal/18_fall_high/start
        execute if entity @s[tag=Ply.Ope.Buffering.A,tag=Ply.Flag.Ss.UpperBashCounter] if score @s Wpn.GeneralTimer matches 25..34 run function mhdp_items:weapons/short_sword/type_normal/18_fall_high/start

# 終了
    execute if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/short_sword/type_normal/30_upper_bash/end
