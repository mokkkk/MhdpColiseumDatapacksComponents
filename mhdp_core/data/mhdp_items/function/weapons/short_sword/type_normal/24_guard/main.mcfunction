...
# 遷移
     # 右クリック：盾攻撃に移行
        execute if entity @s[tag=Ply.Ope.StartUsingEnderEye] unless score @s Wpn.GuardStopTimer matches 3.. run function mhdp_items:weapons/short_sword/type_normal/24_guard/change_to_bash
