...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.short_sword.action.sword_combo_1"}
...
# 先行入力
    ...
    execute if score @s Wpn.GeneralTimer matches 1..9 run function mhdp_items:core/buffering/arts_main
