...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 1 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_0
    ...
    execute if score @s Wpn.AnimationTimer matches 6 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_3
    execute if score @s Wpn.AnimationTimer matches 8 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_4
    ...
    execute if score @s Wpn.AnimationTimer matches 19 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_10
    ...
    execute if score @s Wpn.AnimationTimer matches 60 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_34
    execute if score @s Wpn.AnimationTimer matches 63 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_35
    execute if score @s Wpn.AnimationTimer matches 65 run function mhdp_items:weapons/short_sword/type_normal/13_dance_rush/animation_36
