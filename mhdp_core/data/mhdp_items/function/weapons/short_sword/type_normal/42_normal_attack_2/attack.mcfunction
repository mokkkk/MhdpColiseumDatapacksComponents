#> mhdp_items:weapons/short_sword/type_normal/40_normal_attack_0/attack
#
# 剣コンボ1 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Normal.Attack.3
