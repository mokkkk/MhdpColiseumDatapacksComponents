...
# 移動制限
    attribute @s generic.movement_speed modifier remove mhdp_core:endereye_movement_speed
    execute if score @s Wpn.GeneralTimer matches 1..11 if entity @s[tag=Ply.Ope.IsUsingEnderEye] run attribute @s generic.movement_speed modifier add mhdp_core:endereye_movement_speed 0.3 add_value
