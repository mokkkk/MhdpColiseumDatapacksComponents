...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Normal.BladeDance.5
...
# 演出
    ...
    playsound item.trident.return master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.5
    playsound item.trident.return master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.5
    execute positioned ~ ~1.65 ~ positioned ^ ^0.5 ^1.2 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/particle
    execute positioned ~ ~1.65 ~ positioned ^ ^0.5 ^1.7 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/particle
    execute positioned ~ ~1.65 ~ positioned ^ ^0.5 ^2.2 run function mhdp_items:weapons/short_sword/type_tec/4_horizon_1/particle
