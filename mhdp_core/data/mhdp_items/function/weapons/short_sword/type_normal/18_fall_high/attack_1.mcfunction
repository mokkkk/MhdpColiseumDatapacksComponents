#> mhdp_items:weapons/short_sword/type_normal/18_fall_high/attack_1
#
# フォールバッシュ 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Normal.Fall.High.1
