#> mhdp_items:weapons/short_sword/type_tec/18_fall_high/attack_2
#
# 駆け上がり斬り 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Tec.Fall.High.2
