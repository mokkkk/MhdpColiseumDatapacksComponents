#> mhdp_items:weapons/short_sword/type_normal/2_sword_2/attack
#
# 剣コンボ2 攻撃判定
#
...
# 攻撃
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:game_data WeaponAttackData.ShortSword.Normal.Sword.2
