...
# 移動制限
    ...
    execute if score @s Wpn.GeneralTimer matches 1..10 if entity @s[tag=Ply.Ope.IsUsingEnderEye] run attribute @s generic.movement_speed modifier add mhdp_core:endereye_movement_speed 0.3 add_value
