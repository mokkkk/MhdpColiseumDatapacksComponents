...
# 遷移
    # ヒットした場合、空中溜めに移行
        execute if entity @s[tag=Ply.Flag.Hit] if score @s Wpn.GeneralTimer matches 5 run function mhdp_items:weapons/great_sword/type_normal/11_charge_edge/start_with_other
