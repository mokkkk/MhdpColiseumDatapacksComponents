#> mhdp_items:weapons/great_sword/type_normal/20_counter_stance_success/start
#
# 威姿呵成の構え 開始
#
...
# 演出
    execute positioned ~ ~1.65 ~ run particle flash{color:[1.000,1.000,1.000,1.00]} ^ ^ ^0.2 0 0 0 0 1
...
# タグ付与
    tag @s add Wpn.Gs.Normal.CounterStance.Success
