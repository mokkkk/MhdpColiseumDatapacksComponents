#> mhdp_items:weapons/great_sword/type_normal/11_charge_edge/main
#
# 空中溜め メイン処理
#
...
# 遷移
    # 右クリックを離した場合、溜め斬りに移行
        execute if entity @s[tag=!Ply.Ope.IsUsingEnderEye] if score @s Wpn.GeneralTimer matches 10.. run function mhdp_items:weapons/great_sword/type_normal/11_charge_edge/change_to_chargeattack
