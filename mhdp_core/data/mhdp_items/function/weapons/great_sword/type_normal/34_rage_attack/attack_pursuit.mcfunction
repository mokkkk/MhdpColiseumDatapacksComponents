#> mhdp_items:weapons/great_sword/type_normal/7_chargeattack_high/attack_pursuit
#
# 溜め斬り 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.GreatSword.Normal.Rage.Pursuit
