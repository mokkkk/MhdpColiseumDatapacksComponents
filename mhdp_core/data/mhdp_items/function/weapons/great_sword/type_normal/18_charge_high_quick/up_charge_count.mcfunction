#> mhdp_items:weapons/great_sword/type_tec/6_charge_high/up_charge_count
#
# 強溜め メイン処理
#
...
# 演出
    ...
    execute if score @s Wpn.Gs.ChargeCount matches 3 positioned ~ ~1.4 ~ run particle flash{color:[1.000,1.000,1.000,1.00]} ^ ^ ^0.5 0 0 0 0 1
