#> mhdp_items:weapons/great_sword/type_tec/_index.d
# @private

#> tag
# @within function mhdp_items:weapons/great_sword/type_tec/**
...
# 操作
    ...
    #declare tag Wpn.Gs.Tec.Charge.Edge 空中溜め
    #declare tag Wpn.Gs.Tec.ChargeSlash.Edge 空中溜め斬り
