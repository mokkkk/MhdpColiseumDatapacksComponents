#> mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/main
#
# 強化納刀 メイン処理
#
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches ..2 run function mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/animation_0
    execute if score @s Wpn.AnimationTimer matches 3 run function mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/animation_1
    execute if score @s Wpn.AnimationTimer matches 5 run function mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/animation_2
    execute if score @s Wpn.AnimationTimer matches 7 run function mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/animation_3
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 14.. run function mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/end
