#> mhdp_items:weapons/great_sword/type_tec/30_normal_attack_1/attack
#
# 相殺斬り上げ 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.GreatSword.Tec.Attack.1
