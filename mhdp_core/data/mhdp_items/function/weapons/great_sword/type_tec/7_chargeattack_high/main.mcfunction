...
# 遷移
    ...
    # スニーク+ジャンプ：狩技・強化納刀に移行
        execute if entity @s[tag=Ply.Ope.Buffering.A] if score @s Wpn.GeneralTimer matches 12.. run function mhdp_items:weapons/great_sword/type_tec/17_power_sheathe/start
    # ジャンプ回避
