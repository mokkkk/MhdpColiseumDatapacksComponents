...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 15 run playsound entity.player.attack.sweep master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 1 1
    execute if score @s Wpn.AnimationTimer matches 15 run playsound entity.player.attack.sweep master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 1 0.8
    ...
    execute if score @s Wpn.AnimationTimer matches 15 run function mhdp_items:weapons/great_sword/type_tec/15_cross/animation_5
    execute if score @s Wpn.AnimationTimer matches 16 run function mhdp_items:weapons/great_sword/type_tec/15_cross/animation_6
    execute if score @s Wpn.AnimationTimer matches 17 run function mhdp_items:weapons/great_sword/type_tec/15_cross/animation_7
    execute if score @s Wpn.AnimationTimer matches 19 run function mhdp_items:weapons/great_sword/type_tec/15_cross/animation_8
    ...
    execute if score @s Wpn.AnimationTimer matches 3 positioned ~ ~1.65 ~ positioned ^ ^ ^2.2 run function mhdp_items:weapons/great_sword/type_tec/15_cross/particle_horizon

    execute if score @s Wpn.AnimationTimer matches 15 rotated ~ 0 run function mhdp_items:weapons/great_sword/type_tec/15_cross/effect_on_ground
    execute if score @s Wpn.AnimationTimer matches 16 positioned ^ ^2 ^ rotated ~ ~-30 run function mhdp_items:weapons/great_sword/type_tec/15_cross/particle
    execute if score @s Wpn.AnimationTimer matches 17 positioned ^ ^ ^0.3 rotated ~ ~ run function mhdp_items:weapons/great_sword/type_tec/15_cross/particle
    execute if score @s Wpn.AnimationTimer matches 19 unless block ~ ~-1 ~ #mhdp_core:no_collision rotated ~ 0 run function mhdp_items:weapons/great_sword/type_tec/15_cross/effect_on_ground
...
# 攻撃
    ...
    execute if score @s Wpn.GeneralTimer matches 16 run function mhdp_items:weapons/great_sword/type_tec/15_cross/attack_1
