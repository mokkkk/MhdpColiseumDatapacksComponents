#> mhdp_items:weapons/lance/type_tec/23_rage_counter/main
#
# カウンター突き メイン処理
#
...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.lance.action.rage_counter"}
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 1 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_0
    execute if score @s Wpn.AnimationTimer matches 7 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_1
    execute if score @s Wpn.AnimationTimer matches 8 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_2
    execute if score @s Wpn.AnimationTimer matches 9 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_3
    execute if score @s Wpn.AnimationTimer matches 10 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_4
    execute if score @s Wpn.AnimationTimer matches 12 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_5
    execute if score @s Wpn.AnimationTimer matches 18 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/animation_6
    # execute if score @s Wpn.AnimationTimer matches 2 positioned ~ ~1.65 ~ positioned ^ ^ ^1.2 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/particle
    # execute if score @s Wpn.AnimationTimer matches 2 positioned ~ ~1.65 ~ positioned ^ ^ ^1.7 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/particle
    # execute if score @s Wpn.AnimationTimer matches 2 positioned ~ ~1.65 ~ positioned ^ ^ ^2.2 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/particle

# 攻撃
    execute if score @s Wpn.GeneralTimer matches 10 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/attack_0
    execute if score @s Wpn.GeneralTimer matches 12 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/attack_1
    execute if score @s Wpn.GeneralTimer matches 14 run function mhdp_items:weapons/lance/type_tec/23_rage_counter/attack_1
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/lance/type_tec/23_rage_counter/end
