#> mhdp_items:weapons/short_sword/type_tec/18_dash/attack
#
# 突進 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Tec.Dash
