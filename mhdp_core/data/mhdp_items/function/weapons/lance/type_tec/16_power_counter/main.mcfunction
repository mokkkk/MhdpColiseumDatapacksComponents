#> mhdp_items:weapons/lance/type_tec/16_power_counter/main
#
# カウンター突き メイン処理
#
...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.lance.action.power_counter"}
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 9 run function mhdp_items:weapons/lance/type_tec/16_power_counter/animation_3
    execute if score @s Wpn.AnimationTimer matches 10 run function mhdp_items:weapons/lance/type_tec/16_power_counter/animation_4
    execute if score @s Wpn.AnimationTimer matches 12 run function mhdp_items:weapons/lance/type_tec/16_power_counter/animation_5
    execute if score @s Wpn.AnimationTimer matches 18 run function mhdp_items:weapons/lance/type_tec/16_power_counter/animation_6
    # execute if score @s Wpn.AnimationTimer matches 2 positioned ~ ~1.65 ~ positioned ^ ^ ^1.2 run function mhdp_items:weapons/lance/type_tec/16_power_counter/particle
    # execute if score @s Wpn.AnimationTimer matches 2 positioned ~ ~1.65 ~ positioned ^ ^ ^1.7 run function mhdp_items:weapons/lance/type_tec/16_power_counter/particle
...
# 演出
    ...
    execute if entity @s[tag=!Ply.Option.DisableCameraEffect] if score @s Wpn.GeneralTimer matches 7..9 at @s run tp @s ~ ~ ~ ~-1 ~-0.5
...
# 遷移
     # 左クリック：3連突きに移行
        execute if entity @s[tag=Ply.Ope.Buffering.A] if score @s Wpn.GeneralTimer matches 24.. run function mhdp_items:weapons/lance/type_tec/9_triple_spear/start
     # 右クリック：溜めに移行
...
# 狩技遷移
    execute if entity @s[tag=Ply.Ope.Buffering.Arts1] if score @s Wpn.GeneralTimer matches 24.. run function mhdp_items:weapons/lance/type_tec/22_guard_rage/start
    execute if entity @s[tag=Ply.Ope.Buffering.Arts2] if score @s Wpn.GeneralTimer matches 24.. run function mhdp_items:weapons/lance/type_tec/24_screw_thrust/start

# 終了
    execute if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/lance/type_tec/16_power_counter/end
