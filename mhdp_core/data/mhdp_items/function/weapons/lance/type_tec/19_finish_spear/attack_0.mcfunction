#> mhdp_items:weapons/short_sword/type_tec/19_finish_spear/attack_0
#
# フィニッシュ突き 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Tec.FinishSpear.1
