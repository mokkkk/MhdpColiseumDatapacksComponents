...
# アニメーション演出
    ...
    execute if score @s Wpn.GuardStopTimer matches 1.. run function mhdp_items:weapons/lance/type_tec/15_power_guard/animation_0
    execute if score @s Wpn.GuardStopTimer matches 0 run function mhdp_items:weapons/lance/type_tec/15_power_guard/animation_1
...
# 終了
    # execute if entity @s[tag=!Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 10.. if score @s Wpn.GuardStopTimer matches 0 run function mhdp_items:weapons/lance/type_tec/15_power_guard/end
