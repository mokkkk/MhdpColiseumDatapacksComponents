#> mhdp_items:weapons/lance/type_tec/22_guard_rage/main
#
# ガードレイジ メイン処理
#
...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.lance.action.guard_rage"}
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 1 run function mhdp_items:weapons/lance/type_tec/22_guard_rage/animation_0
    execute if score @s Wpn.AnimationTimer matches 3 run function mhdp_items:weapons/lance/type_tec/22_guard_rage/animation_1
    execute if score @s Wpn.AnimationTimer matches 5 run function mhdp_items:weapons/lance/type_tec/22_guard_rage/animation_2
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 81.. run function mhdp_items:weapons/lance/type_tec/22_guard_rage/end
