...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 15 if score @s Wpn.Lc.ChargeCount matches 1.. positioned ~ ~1.65 ~ positioned ^ ^ ^6 run function mhdp_items:weapons/lance/type_tec/25_screw_thrust_spear/particle_1
    execute if score @s Wpn.AnimationTimer matches 17 if score @s Wpn.Lc.ChargeCount matches 2.. positioned ~ ~1.65 ~ positioned ^ ^ ^8 run function mhdp_items:weapons/lance/type_tec/25_screw_thrust_spear/particle_1
    execute if score @s Wpn.AnimationTimer matches 19 if score @s Wpn.Lc.ChargeCount matches 2.. positioned ~ ~1.65 ~ positioned ^ ^ ^10 run function mhdp_items:weapons/lance/type_tec/25_screw_thrust_spear/particle_1
...
# 先行入力
    execute if entity @s[tag=Ply.Ope.StartLeftClick,tag=!Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 3..49 run function mhdp_items:core/buffering/a
    execute if entity @s[tag=Ply.Ope.StartUsingEnderEye,tag=!Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 3..49 run function mhdp_items:core/buffering/b
    execute if entity @s[tag=Ply.Ope.StartKeyJump,tag=Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 3..49 run function mhdp_items:core/buffering/c
...
# 遷移
     # 左クリック：突き1に移行
        execute if entity @s[tag=Ply.Ope.Buffering.A] if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/lance/type_tec/1_spear_1/start
     # 右クリック：溜めに移行
        execute if entity @s[tag=Ply.Ope.Buffering.B] if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/lance/type_tec/4_charge/start
     # スニーク+ジャンプ：ガードダッシュに移行
        execute if entity @s[tag=Ply.Ope.Buffering.C] if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/lance/type_tec/7_guard_dash/start
    # ジャンプ：ステップに移行
        execute if entity @s[tag=Ply.Ope.Buffering.Jump] if score @s Wpn.GeneralTimer matches 35.. run function mhdp_items:weapons/lance/type_tec/10_step/start
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 50.. run function mhdp_items:weapons/lance/type_tec/25_screw_thrust_spear/end
