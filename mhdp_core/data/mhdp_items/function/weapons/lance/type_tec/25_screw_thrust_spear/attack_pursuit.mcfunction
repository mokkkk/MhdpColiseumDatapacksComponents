#> mhdp_items:weapons/short_sword/type_tec/25_screw_thrust_spear/attack_pursuit
#
# スクリュースラスト 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Tec.ScrewThrust.Pursuit
