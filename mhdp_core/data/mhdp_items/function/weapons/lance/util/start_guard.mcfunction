...
# ダミー用AEC召喚
    ...
    execute unless data storage mhdp_core:temp Arg{VectorType:"Normal"} facing entity @s feet positioned as @s rotated ~180 0 positioned ^ ^ ^1 run summon area_effect_cloud ~ ~ ~ {Tags:["Other.Temp.GuardVector"]}
# 判定
    # 通常時
