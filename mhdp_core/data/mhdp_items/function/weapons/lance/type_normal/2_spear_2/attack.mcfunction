#> mhdp_items:weapons/short_sword/type_normal/2_spear_2/attack
#
# 突き2 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Normal.Spear.2
