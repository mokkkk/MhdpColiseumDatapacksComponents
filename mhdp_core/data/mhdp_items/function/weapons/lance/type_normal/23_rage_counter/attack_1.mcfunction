#> mhdp_items:weapons/short_sword/type_normal/12_counter_spear/attack
#
# カウンター突き 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Normal.RageCounter.2
