#> mhdp_items:weapons/short_sword/type_normal/5_dash_spear/attack
#
# 飛び込み突き 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Normal.DashSpear.0
