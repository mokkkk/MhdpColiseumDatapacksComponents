...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.lance.action.leaping_thrust"}
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 6..9 run playsound block.grass.step master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1
    execute if score @s Wpn.AnimationTimer matches 6 run particle block{block_state:"minecraft:sand"} ~ ~0.1 ~ 0.4 0.1 0.4 0 10
    execute if score @s Wpn.AnimationTimer matches 14 run playsound item.spear.lunge_1 master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 0.8
    ...
    execute if score @s Wpn.AnimationTimer matches 6 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/animation_0
    execute if score @s Wpn.AnimationTimer matches 9 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/animation_1
    execute if score @s Wpn.AnimationTimer matches 13 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/animation_2
    execute if score @s Wpn.AnimationTimer matches 14 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/animation_3
    execute if score @s Wpn.AnimationTimer matches 17 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/animation_4
    execute if score @s Wpn.AnimationTimer matches 19 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/animation_5
...
# 攻撃
    execute if score @s Wpn.GeneralTimer matches 14 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/attack
    execute if score @s Wpn.GeneralTimer matches 16 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/attack_pursuit
    execute if score @s Wpn.GeneralTimer matches 19 run function mhdp_items:weapons/lance/type_normal/5_dash_spear/attack_pursuit
...
# 移動
    ...
    execute if score @s Wpn.GeneralTimer matches 6 rotated ~ -15 run function api:weapon_operation/use_player_motion.m {Strength:9000, IsForce:true, IsAdjust:true}
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 28.. run function mhdp_items:weapons/lance/type_normal/5_dash_spear/end
