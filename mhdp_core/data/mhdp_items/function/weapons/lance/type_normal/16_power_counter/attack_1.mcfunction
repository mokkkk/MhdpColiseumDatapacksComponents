#> mhdp_items:weapons/short_sword/type_tec/16_power_counter/attack_1
#
# カウンター突き 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Tec.PowerCounter.2
