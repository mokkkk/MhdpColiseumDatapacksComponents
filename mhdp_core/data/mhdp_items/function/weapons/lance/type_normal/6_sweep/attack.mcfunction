#> mhdp_items:weapons/short_sword/type_normal/6_sweepattack
#
# 薙ぎ払い 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Normal.Sweep.1
