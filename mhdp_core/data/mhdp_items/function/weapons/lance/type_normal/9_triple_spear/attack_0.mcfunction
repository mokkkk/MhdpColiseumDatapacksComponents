#> mhdp_items:weapons/short_sword/type_tec/9_triple_spear/attack
#
# 3連突き 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.Lance.Tec.TripleSpear.1
