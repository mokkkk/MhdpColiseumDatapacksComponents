...
# アニメーション演出
    ...
    execute if score @s Wpn.GeneralTimer matches 14 run playsound item.trident.throw master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.2
    ...
    execute if score @s Wpn.GeneralTimer matches 23 run playsound item.trident.throw master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.2
