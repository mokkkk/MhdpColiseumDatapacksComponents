#> mhdp_items:weapons/long_sword/type_tec/26_sakura_slash/end
#
# 桜花気刃斬り 終了処理
#
# @within function mhdp_items:weapons/long_sword/type_tec/26_sakura_slash/main

# タグ消去
    tag @s remove Wpn.Ls.Tec.SakuraSlash
