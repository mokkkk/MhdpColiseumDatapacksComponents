...
# アニメーション演出
    ...
    execute if score @s Wpn.GeneralTimer matches 5 run playsound item.trident.throw master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.2
...
# 攻撃
    execute if score @s Wpn.GeneralTimer matches 5 rotated ~ 0 positioned ^ ^ ^-2 run function mhdp_items:weapons/long_sword/type_tec/22_iai_spirit_slash/attack
