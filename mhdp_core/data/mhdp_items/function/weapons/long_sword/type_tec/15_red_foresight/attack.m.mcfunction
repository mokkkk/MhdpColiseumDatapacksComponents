#> mhdp_items:weapons/short_sword/type_tec/15_red_foresight/attack.m
#
# 見切り斬り 攻撃判定
#
...
# 攻撃
    $data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.RedForesight.$(Type)
