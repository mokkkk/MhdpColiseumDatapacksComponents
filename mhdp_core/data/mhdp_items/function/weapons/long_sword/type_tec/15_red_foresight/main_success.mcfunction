...
# 先行入力
    ...
    execute if entity @s[tag=Ply.Ope.StartLeftClick,tag=Ply.Ope.IsKeyJump] if score @s Wpn.GeneralTimer matches 3..35 run function mhdp_items:core/buffering/c
    execute if entity @s[tag=Ply.Ope.StartUsingEnderEye,tag=Ply.Ope.IsKeyJump] if score @s Wpn.GeneralTimer matches 3..35 run function mhdp_items:core/buffering/d
    execute if entity @s[tag=Ply.Ope.StartUsingEnderEye,tag=Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 3..35 run function mhdp_items:core/buffering/e
    execute if entity @s[tag=Ply.Ope.IsKeyJump.Short,tag=!Ply.Ope.IsKeySprint,tag=!Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 3..35 run function mhdp_items:core/buffering/jump
    execute if entity @s[tag=Ply.Ope.StartKeyJump,tag=Ply.Ope.IsSneaking] if score @s Wpn.GeneralTimer matches 3..35 run function mhdp_items:core/buffering/f
...
# 遷移
    ...
    # 右クリック：気刃大回転斬りに移行
        execute if entity @s[tag=Ply.Ope.Buffering.B] if score @s Wpn.GeneralTimer matches 14.. run function mhdp_items:weapons/long_sword/type_tec/7_spirit_spin/start
    # スニーク右クリック同時：気刃突きに移行
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 36.. run function mhdp_items:weapons/long_sword/type_tec/15_red_foresight/end
