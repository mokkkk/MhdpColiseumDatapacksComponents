...
# タイマー増加
    ...
    execute if score @s Wpn.GeneralTimer matches 7.. run scoreboard players add @s Wpn.GeneralTimer 3
    execute if score @s Wpn.GeneralTimer matches 51.. run scoreboard players add @s Wpn.AnimationTimer 1
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 1 run playsound item.axe.scrape master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1.7
    execute if score @s Wpn.AnimationTimer matches 1 run playsound item.trident.return master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 0.7
    ...
    execute if score @s Wpn.GeneralTimer matches 7..16 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_3
    execute if score @s Wpn.GeneralTimer matches 17..26 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_4
    execute if score @s Wpn.GeneralTimer matches 27..36 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_5
    execute if score @s Wpn.GeneralTimer matches 37..46 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_6
    execute if score @s Wpn.AnimationTimer matches 1 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_7
    execute if score @s Wpn.AnimationTimer matches 2 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_8
    execute if score @s Wpn.AnimationTimer matches 3 run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/animation_7
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 1200.. run function mhdp_items:weapons/long_sword/type_tec/20_special_sheathe/end
