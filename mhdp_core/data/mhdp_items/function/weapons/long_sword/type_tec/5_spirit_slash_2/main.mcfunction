...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 5 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/animation_2
    execute if score @s Wpn.AnimationTimer matches 9 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/animation_3
    execute if score @s Wpn.AnimationTimer matches 10 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/animation_4
    execute if score @s Wpn.AnimationTimer matches 11 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/animation_5
    execute if score @s Wpn.GeneralTimer matches 10 positioned ~ ~1.65 ~ positioned ^-0.3 ^ ^1.2 rotated ~80 30 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/particle
    execute if score @s Wpn.GeneralTimer matches 10 positioned ~ ~1.65 ~ positioned ^-0.3 ^ ^2.2 rotated ~80 30 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/particle

# 攻撃
    execute if score @s Wpn.GeneralTimer matches 10 run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/attack

# 移動
    execute if score @s Wpn.GeneralTimer matches 10 rotated ~180 0 run function api:weapon_operation/use_player_motion.m {Strength:2500, IsForce:false, IsAdjust:false}
...
# 遷移
     # 左クリック：斬り上げ(コンボ用)に移行
        execute if entity @s[tag=Ply.Ope.Buffering.A] if score @s Wpn.GeneralTimer matches 17.. run function mhdp_items:weapons/long_sword/type_tec/3_normal_3/start_in_spirit
     # 右クリック：気刃斬り3に移行
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 28.. run function mhdp_items:weapons/long_sword/type_tec/5_spirit_slash_2/end
