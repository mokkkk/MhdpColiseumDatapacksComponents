...
# 攻撃
    execute if score @s Wpn.Ls.SpiritLevel matches ..1 run data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.CriticalCounter.1
    execute if score @s Wpn.Ls.SpiritLevel matches 2 run data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.CriticalCounter.2
    execute if score @s Wpn.Ls.SpiritLevel matches 3.. run data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.CriticalCounter.3
