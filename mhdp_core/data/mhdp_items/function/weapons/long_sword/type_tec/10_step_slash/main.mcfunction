#> mhdp_items:weapons/long_sword/type_tec/10_step_slash/main
#
# 踏み込み斬り メイン処理
#
...
# 操作表示
    execute if score @s Wpn.GeneralTimer matches 1 run function mhdp_items:core/util/item_modify_custom_name {Name:"weapon.long_sword.action.step_slash"}
...
# アニメーション演出
    ...
    execute if score @s Wpn.AnimationTimer matches 1 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/animation_0
    execute if score @s Wpn.AnimationTimer matches 4 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/animation_1
    execute if score @s Wpn.AnimationTimer matches 6 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/animation_2
    execute if score @s Wpn.AnimationTimer matches 7 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/animation_3
    execute if score @s Wpn.AnimationTimer matches 5 positioned ~ ~1.65 ~ positioned ^-0.3 ^ ^1.2 rotated ~80 -80 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/particle
    execute if score @s Wpn.AnimationTimer matches 5 positioned ~ ~1.65 ~ positioned ^-0.3 ^ ^2.2 rotated ~80 -80 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/particle

# 攻撃
    execute if score @s Wpn.GeneralTimer matches 6 run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/attack
...
# 移動
    ...
    execute if score @s Wpn.GeneralTimer matches 6 rotated ~ 0 run function api:weapon_operation/use_player_motion.m {Strength:6000, IsForce:false, IsAdjust:false}
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 28.. run function mhdp_items:weapons/long_sword/type_tec/10_step_slash/end
