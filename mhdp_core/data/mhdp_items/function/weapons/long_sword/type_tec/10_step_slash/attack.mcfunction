#> mhdp_items:weapons/long_sword/type_tec/10_step_slash/attack
#
# 踏み込み斬り 攻撃判定
#
# @within function mhdp_items:weapons/long_sword/type_tec/10_step_slash/change_to_chargeattack
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.Normal.1
