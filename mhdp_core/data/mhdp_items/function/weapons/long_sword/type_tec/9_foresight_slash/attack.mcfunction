#> mhdp_items:weapons/short_sword/type_tec/9_foresight_slash/attack
#
# 見切り斬り 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.Foresight
