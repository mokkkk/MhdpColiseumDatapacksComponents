#> mhdp_items:weapons/long_sword/type_normal/27_critical_juncture/main
#
# 鏡花の構え メイン処理
#
...
# アニメーション演出
    execute if score @s Wpn.AnimationTimer matches 1 run function mhdp_items:weapons/long_sword/type_normal/27_critical_juncture/animation_0
    execute if score @s Wpn.AnimationTimer matches 3 run function mhdp_items:weapons/long_sword/type_normal/27_critical_juncture/animation_1
...
# 終了
    execute if score @s Wpn.GeneralTimer matches 61.. run function mhdp_items:weapons/long_sword/type_normal/27_critical_juncture/end
