#> mhdp_items:weapons/short_sword/type_tec/4_spirit_slash_1/attack_miss
#
# 気刃斬り 攻撃判定
#
...
# 攻撃
    data modify storage api: Arg set from storage mhdp_core:game_data WeaponAttackData.LongSword.Tec.Spirit.Miss
