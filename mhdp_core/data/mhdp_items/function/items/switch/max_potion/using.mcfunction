...
# 演出
    execute if score @s Ply.Ope.EatingTimer.Effect matches 4 positioned ~ ~1.6 ~ run particle dust{color:[100000000.000,100000000.000,1.000],scale:0.5} ^ ^ ^0.4 0.1 0.1 0.1 0 3 normal
    ...
    execute if score @s Ply.Ope.EatingTimer.Effect matches 8 positioned ~ ~1.6 ~ run particle dust{color:[100000000.000,100000000.000,1.000],scale:0.5} ^ ^ ^0.4 0.1 0.1 0.1 0 3 normal
