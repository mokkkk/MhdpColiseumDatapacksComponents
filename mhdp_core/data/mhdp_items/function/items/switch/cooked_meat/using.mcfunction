#> mhdp_items:items/switch/cooked_beef/using
#
# こんがり肉使用処理
#
...
# 演出
    execute if score @s Ply.Ope.EatingTimer.Effect matches 4.. positioned ~ ~1.6 ~ run particle item{item:"cooked_beef"} ^ ^ ^0.4 0.1 0.1 0.1 0.05 1 normal
