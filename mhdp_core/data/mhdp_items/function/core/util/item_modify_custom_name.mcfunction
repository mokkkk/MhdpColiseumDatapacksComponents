...
# データ取得
    ...
    $data modify storage mhdp_core:temp Args.Name set value "$(Name)"
...
# 実行
    function mhdp_items:core/util/macro/m.item_modify_custom_name with storage mhdp_core:temp Args
