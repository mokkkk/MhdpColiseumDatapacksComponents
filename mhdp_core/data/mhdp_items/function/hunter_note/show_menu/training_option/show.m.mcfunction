...
# 表示
    $return run dialog show @s {\
        ...
        title:{translate:"ui.hunter_note.menu.training.show_option",bold:1b},external_title:{translate:"ui.hunter_note.menu.training.show_option"},body:[],can_close_with_escape:1b,after_action:"close",\
        inputs:[\
...
# 保持
    dialog show @s {\
        type:"minecraft:confirmation",\
        title:{translate:"ui.hunter_note.menu.training",bold:1b},external_title:{translate:"ui.hunter_note.menu.training"},body:[],can_close_with_escape:1b,after_action:"close",\
        inputs:[\
            {type:"minecraft:single_option",key:"OptArtsGaugeInfinity",label:{translate:"ui.hunter_note.menu.training.arts_gauge_infinity"},options:[\
