#> mhdp_items:weapons/great_sword/type_normal/5_charge_draw/change_to_chargeattack
#
# 溜め → 溜め斬り
#
# @within function mhdp_items:weapons/great_sword/type_normal/5_charge_draw/main
