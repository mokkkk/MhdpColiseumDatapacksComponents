#> mhdp_items:weapons/great_sword/type_tec/10_hunting_edge/change_to_charge
#
# ハンティングエッジ → 空中溜め
#
...
# 対象の処理を実行
    function mhdp_items:weapons/great_sword/type_tec/11_charge_edge/start_with_other
