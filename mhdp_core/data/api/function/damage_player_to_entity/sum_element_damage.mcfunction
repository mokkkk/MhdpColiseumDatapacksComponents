#> api:damage_player_to_entity/sum_element_damage
#
# 各属性ダメージを mhdp_temp_damage_element_value に加算
#
...
# 水
    ...
    execute if score #mhdp_temp_element_value_water MhdpCore > #mhdp_temp_damage_element_max MhdpCore run scoreboard players set #mhdp_temp_damage_element_vfx_type MhdpCore 2
...
# 雷
    ...
    execute if score #mhdp_temp_element_value_thunder MhdpCore > #mhdp_temp_damage_element_max MhdpCore run scoreboard players set #mhdp_temp_damage_element_vfx_type MhdpCore 3
...
# 氷
    ...
    execute if score #mhdp_temp_element_value_ice MhdpCore > #mhdp_temp_damage_element_max MhdpCore run scoreboard players set #mhdp_temp_damage_element_vfx_type MhdpCore 4
...
# 龍
    ...
    execute if score #mhdp_temp_element_value_dragon MhdpCore > #mhdp_temp_damage_element_max MhdpCore run scoreboard players set #mhdp_temp_damage_element_vfx_type MhdpCore 5
