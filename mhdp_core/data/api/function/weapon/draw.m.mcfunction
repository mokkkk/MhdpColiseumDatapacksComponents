...
# アイテム書き換え
    $item modify entity @s weapon.$(Slot) [{function: set_custom_model_data, strings:{values :["$(Cmd)"], mode: replace_all}} ,{function: set_custom_data,tag:{IsDrawing:1b,IsSubWeapon:0b}},{"function":"minecraft:set_name","entity":"this","name":{"text":" ","type":"text"},"target":"custom_name"}]
