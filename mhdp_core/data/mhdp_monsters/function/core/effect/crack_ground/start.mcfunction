...
# 召喚
    summon block_display ^1.2 ^-1 ^0.8 {start_interpolation:-1,interpolation_duration:3,brightness:{sky:15,block:15},Tags:["Effect.General","Effect.CrackGround","Effect.CrackGround.A","Start"],block_state:{Name:"minecraft:sandstone"}}
    summon block_display ^-1.0 ^-1 ^0.8 {start_interpolation:-1,interpolation_duration:3,brightness:{sky:15,block:15},Tags:["Effect.General","Effect.CrackGround","Effect.CrackGround.B","Start"],block_state:{Name:"minecraft:sandstone"}}
    summon block_display ^1.2 ^-1 ^-0.8 {start_interpolation:-1,interpolation_duration:3,brightness:{sky:15,block:15},Tags:["Effect.General","Effect.CrackGround","Effect.CrackGround.C","Start"],block_state:{Name:"minecraft:sandstone"}}
    summon block_display ^-0.8 ^-1 ^-0.8 {start_interpolation:-1,interpolation_duration:3,brightness:{sky:15,block:15},Tags:["Effect.General","Effect.CrackGround","Effect.CrackGround.D","Start"],block_state:{Name:"minecraft:sandstone"}}
