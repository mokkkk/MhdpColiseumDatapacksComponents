...
# 表示変更
    ...
    execute if entity @s[tag=Other.Text.Vfx.Ride,tag=!Other.Text.Vfx.Counter] if score @s MhdpCore matches 2 run data modify entity @s text set value {"text":"1","font":"vfx/slash_ride"}
    execute if entity @s[tag=Other.Text.Vfx.Ride,tag=!Other.Text.Vfx.Counter] if score @s MhdpCore matches 3 run data modify entity @s text set value {"text":"2","font":"vfx/slash_ride"}
    execute if entity @s[tag=Other.Text.Vfx.Ride,tag=!Other.Text.Vfx.Counter] if score @s MhdpCore matches 4 run data modify entity @s text set value {"text":"3","font":"vfx/slash_ride"}
    execute if entity @s[tag=Other.Text.Vfx.Ride,tag=!Other.Text.Vfx.Counter] if score @s MhdpCore matches 5 run data modify entity @s text set value {"text":"4","font":"vfx/slash_ride"}
    execute if entity @s[tag=Other.Text.Vfx.Ride,tag=!Other.Text.Vfx.Counter] if score @s MhdpCore matches 6 run data modify entity @s text set value {"text":"5","font":"vfx/slash_ride"}
