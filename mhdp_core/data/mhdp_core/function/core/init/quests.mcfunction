...
# テスト用
    data modify storage mhdp_core:game_data QuestList append value {\
        ID:1,Name:"火竜の狩猟",Level:1,Pos:0,IsEmergency:false,HideMonsters:false,\
        State:{IsPlayed:false,IsCleared:false,IsHardCleared:false,Visible:true},\
...
# テスト用
    data modify storage mhdp_core:game_data QuestList append value {\
        ID:2,Name:"DEBUG:さんどばっぐくん",Level:1,Pos:0,IsEmergency:false,HideMonsters:false,\
        State:{IsPlayed:false,IsCleared:false,IsHardCleared:false,Visible:true},\
...
# テスト用
    data modify storage mhdp_core:game_data QuestList append value {\
        ID:3,Name:"DEBUG:テスト用クエスト2",Level:3,Pos:0,IsEmergency:false,HideMonsters:false,\
        State:{IsPlayed:false,IsCleared:false,IsHardCleared:false,Visible:true},\
...
# テスト用
    data modify storage mhdp_core:game_data QuestList append value {\
        ID:4,Name:"DEBUG:とってもながいクエスト名てすと",Level:7,Pos:0,IsEmergency:false,HideMonsters:false,\
        State:{IsPlayed:false,IsCleared:false,IsHardCleared:false,Visible:true},\
...
# テスト用
    data modify storage mhdp_core:game_data QuestList append value {\
        ID:5,Name:"DEBUG:非表示クエスト",Level:7,Pos:0,IsEmergency:false,HideMonsters:true,\
        State:{IsPlayed:false,IsCleared:false,IsHardCleared:false,Visible:true},\
