...
# クエスト中
    # 目標確認
    # 武器操作確認
        execute if score @s Ply.Ope.HunterNote.ShowMenu matches 22 run function mhdp_items:hunter_note/info/weapon_guide/show.m {Trigger:"Ply.Ope.HunterNote.General",Value:"1"}
    # リタイア投票
        execute if score @s Ply.Ope.HunterNote.ShowMenu matches 23 run function mhdp_core:phase/3_quest/map/general/click_retire_dialog
