...
# キー入力
    ...
    execute if entity @s[tag=Ply.Ope.IsKeyJump.Short] run tag @s remove Ply.Ope.IsKeyJump.Short
    execute if entity @s[tag=Ply.Ope.IsKeyJump.Long] run tag @s remove Ply.Ope.IsKeyJump.Long
