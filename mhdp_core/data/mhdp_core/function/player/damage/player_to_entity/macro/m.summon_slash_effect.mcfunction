...
# 斬撃エフェクト表示用item_display召喚
    $execute positioned ~ ~$(OffsetY) ~ run summon text_display ^ ^ ^$(OffsetZ) {width:2f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-$(VfxOffset)f,0f,0f],scale:[4f,4f,4f]},Tags:["Other.Text.Vfx","Other.Text.Vfx.Slash","Start"],teleport_duration:0,brightness:{sky:15,block:15},text:'{"text":"0","font":"vfx/slash"}',background:0}
