...
# 斬れ味の取得
    ...
    execute store result storage mhdp_core:temp Args.CurrentSharpness int 1 store result storage mhdp_core:temp Result.CurrentSharpness int 1 run scoreboard players remove #mhdp_temp_sharpness_current MhdpCore 1
