...
# 地面に着くまで再帰
    ...
    execute if block ~ ~ ~ #mhdp_core:no_collision unless block ~ ~-1 ~ #mhdp_core:no_collision align y run spawnpoint @s ~ ~0.5 ~
    # execute if block ~ ~ ~ #mhdp_core:no_collision unless block ~ ~-1 ~ #mhdp_core:no_collision align y run particle end_rod ~ ~0.5 ~ 0 0 0 0.0 100
