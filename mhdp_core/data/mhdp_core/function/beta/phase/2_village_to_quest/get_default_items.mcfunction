...
# # 生肉
#     item replace entity @s inventory.1 with paper[item_name='{"text":"生肉","color":"green","italic":false}',custom_name='{"text":"生肉","color":"green","italic":false}',lore=['{"text":"--------------------","color":"dark_gray"}','{"text":"肉焼きセットを使えば","color":"white","italic":false}','{"text":"焼いて食べることができる。","color":"white","italic":false}','{"text":"","color":"white","italic":false}','{"text":"--------------------","color":"dark_gray"}'],max_stack_size=10,custom_model_data=57,custom_data={IsMhdpItem:1b,ItemType:1,ItemId:57,ItemName:"RawMeat",UseTimer:99999999}] 2
...
# item_name={"text":"回復薬","color":"green","italic":false},
# custom_name={"text":"回復薬","color":"green","italic":false},
# lore=[{"text":"--------------------","color":"dark_gray"},{"text":"体力を少量回復する薬。","color":"white","italic":false},{"text":"","color":"white","italic":false},{"text":"","color":"white","italic":false},{"text":"--------------------","color":"dark_gray"}],
# max_stack_size=10,
# item_model="minecraft:consume_items/potion",
# food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:2147483647},
# custom_data={IsMhdpItem:1b,ItemType:1,ItemId:1,ItemName:"Potion",UseTimer:40}