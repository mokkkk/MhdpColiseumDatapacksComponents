#> mhdp_core:beta/phase/1_village/select_weapon/select_long_sword_tec
#
# 武器選択 大剣 天の型
#
...
# 通知
    tellraw @s {"translate":"beta.village.select_weapon.type_tec","with":[{"translate":"weapon.generic.weapon_type.long_sword"}],"color": "light_purple"}
