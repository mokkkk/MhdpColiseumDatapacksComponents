#> mhdp_core:beta/phase/1_village/select_weapon/select_bow_normal
#
# 武器選択 大剣 地の型
#
...
# 通知
    tellraw @s {"translate":"beta.village.select_weapon.type_normal","with":[{"translate":"weapon.generic.weapon_type.bow"}],"color": "light_purple"}
    playsound ui.button.click master @s ~ ~ ~ 1 1

# タグ付与
    function mhdp_core:beta/phase/1_village/select_weapon/remove_tag
    tag @s add Beta.Ply.SelectedWeapon
    tag @s add Beta.Ply.Weapon.Bow
