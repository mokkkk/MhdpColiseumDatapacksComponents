...
# Display
    ...
    summon item_display 242 66.3 198 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":201}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Bw.Normal"]}
    summon item_display 244 66.3 198 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":201}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Bw.Tec"]}
