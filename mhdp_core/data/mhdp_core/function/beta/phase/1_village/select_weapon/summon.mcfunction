...
# Display
    summon item_display -80.3 71.7 795.6 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":301}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Ss.Normal"]}
    summon item_display -80.6 72.1 795.3 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":303}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Ss.Normal"]}
    summon item_display -81 72.3 799 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":201}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Gs.Normal"]}
    summon item_display -81 72.3 803 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":104}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Bw.Normal"]}
...
# チュートリアルクリア後、天の型解放
    ...
    # Display
        summon item_display -80.3 71.7 797.6 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":301}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Ss.Tec"]}
        summon item_display -80.6 72.1 797.3 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":303}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Ss.Tec"]}
        summon item_display -81 72.3 801 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":201}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Gs.Tec"]}
        summon item_display -81 72.3 805 {item_display:"head",item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_model_data":104}},Tags:["Other.Interaction.UI","Beta.Ui","Beta.Display.Bw.Tec"]}
    # Lectern
