...
# フラグリセット
    data modify storage mhdp_core:save_data Flag set value {BetaTutorial:false, BetaRanposuHard:false, BetaReusHard:false, BetaDinoHard:false, BetaValkHard:false}
