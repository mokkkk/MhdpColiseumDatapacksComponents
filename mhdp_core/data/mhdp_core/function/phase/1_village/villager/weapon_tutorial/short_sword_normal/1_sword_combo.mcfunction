...
# メッセージ
    ...
    execute if score @s Vlg.General.Timer matches 60 run tellraw @a[tag=Ply.State.IsTraining,team=Team.WeaponTutorial] [\
        ...
        {"text":"  最大で5回まで連続で使用でき、\n","color": "#00FFC3","bold": false},\
        {"text":"  ","color": "#00FFC3","bold": false},{"text":"後半の攻撃","color": "#ff9900","bold": true},{"text":" ほど高威力になります","color": "#00FFC3","bold": false}\
    ]
...
# スコア設定
    execute if score @s Vlg.General.Timer matches 2 run scoreboard players set $mhdp_temp_weapon_tutorial_value Vlg.WeaponTutorial.Text 5
...
# 遷移：時間
    execute if score $mhdp_temp_weapon_tutorial_value Vlg.WeaponTutorial.Text matches ..0 \
            if score @s Vlg.General.Timer matches 400.. run function mhdp_monster_tutorial_01:core/tick/change_phase
