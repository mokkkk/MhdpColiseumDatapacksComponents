...
# メッセージ
    ...
    execute if score @s Vlg.General.Timer matches 60 run tellraw @a[tag=Ply.State.IsTraining,team=Team.WeaponTutorial] [\
        ...
        {"text":"  ","color": "#FFFFFF","bold": false},{"text":"溜め斬り","color": "#ff9900","bold": true},{"text":" は、","color": "#FFFFFF","bold": false},\
        {"text":"  ","color": "#FFFFFF","bold": false},{"text":"スニークせずマウス","color": "#ff9900","bold": true},{"keybind":"key.use","color": "#ff9900","bold": true},{"text":" 長押しで発動します。\n","color": "#FFFFFF","bold": false},\
        {"text":"  ボタンを長押しする限り力を溜め、離すと攻撃します。\n","color": "#00FFC3","bold": false},\
        {"text":"  3段階まで力を溜めることができ、\n","color": "#FFFFFF","bold": false},\
        {"text":"  ","color": "#FFFFFF","bold": false},{"text":"溜めるほど高威力","color": "#ff9900","bold": true},{"text":" の攻撃ができます。\n","color": "#FFFFFF","bold": false},\
        {"text":"  ただし、溜めすぎると勝手に溜め斬りが発動し、\n","color": "#FFFFFF","bold": false},\
        {"text":"  ","color": "#FFFFFF","bold": false},{"text":"逆に威力が下がってしまう","color": "#ff9900","bold": true},{"text":" ので注意してください。\n","color": "#FFFFFF","bold": false}\
    ]
    ...
    execute if score @s Vlg.General.Timer matches 210 run tellraw @a[tag=Ply.State.IsTraining,team=Team.WeaponTutorial] [\
        ...
        {"text":"  素早く ","color": "#FFFFFF","bold": false},{"text":"納刀して隙をキャンセル","color": "#ff9900","bold": true},{"text":" することで、\n","color": "#FFFFFF","bold": false},\
    ...
    execute if score @s Vlg.General.Timer matches 410 run tellraw @a[tag=Ply.State.IsTraining,team=Team.WeaponTutorial] [\
        ...
        {"text":"  空中で抜刀攻撃をすると、","color": "#FFFFFF","bold": false},{"text":"前進しながら","color": "#ff9900","bold": true},{"text":" 溜めに移行します。\n","color": "#FFFFFF","bold": false},\
