...
# メッセージ
    ...
    execute if score @s Vlg.General.Timer matches 60 run tellraw @a[tag=Ply.State.IsTraining,team=Team.WeaponTutorial] [\
        ...
        {"text":"  竜の一矢は "},{"text":"貫通し、複数回ヒット","color": "#ff9900","bold": true},{"text":" します。\n"},\
        {"text":"  また、クリティカル距離が長く、遠くからでも大ダメージを与えられます。\n"},\
        {"text":"  竜の一矢は "},{"text":"切断属性","color": "#ff9900","bold": true},{"text":" を持つため、尻尾などへのダメージが上がります。\n"}\
    ]
    ...
    execute if score @s Vlg.General.Timer matches 200 run tellraw @a[tag=Ply.State.IsTraining,team=Team.WeaponTutorial] [\
        ...
        {"text":"  大量の矢を装填する "},{"text":"竜の千々矢","color": "#ff9900","bold": true},{"text":" が発動します。\n"},\
        {"text":"  矢の装填が終わった後にボタンを離すと攻撃します。\n"},\
        {"text":"  無数の矢を一度に放ち "},{"text":"複数回ヒット","color": "#ff9900","bold": true},{"text":" する攻撃をします。\n"},\
        {"text":"  射撃時に拡散してしまうため、"},\
        {"text":" "},{"text":"モンスターに密着","color": "#ff9900","bold": true},{"text":" すると当てやすいです。\n"}\
    ]
