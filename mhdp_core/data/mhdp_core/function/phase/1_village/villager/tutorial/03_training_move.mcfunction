#> mhdp_core:phase/1_village/villager/tutorial/03_training_move
#
# tick処理
#
...
# チュートリアル表示
    ...
    execute if score @s Vlg.General.Timer matches 10 run tellraw @a[tag=!Ply.State.PlayingQuest] [\
        ...
        {"text":"\n【 チュートリアル：訓練所 ","color":"#00FFC3","bold": true},{"text":"1/2","color":"#00FFC3","bold": false},{"text":" 】\n\n","color":"#00FFC3","bold": true},\
        {"text":"  次に、武器の練習ができる訓練所について説明します。\n"},\
        {"text":"  上空で点滅する "},{"text":"↓","color": "#ff9900","bold": true},{"text":" マークを見つけて、"},\
        {"text":"  そこまで移動してください。\n"}\
    ]

# 遷移：移動後
    execute if score @s Vlg.General.Timer matches 100.. positioned 249 65 217 if entity @a[tag=!Ply.State.PlayingQuest,distance=..4] run function mhdp_core:phase/1_village/villager/tutorial/change_phase
