...
# チュートリアル表示
    ...
    execute if score @s Vlg.General.Timer matches 10 run tellraw @a[tag=!Ply.State.PlayingQuest] [\
        ...
        {"text":"  このベルを鳴らすと、 ","color": "#00FFC3","bold": false},{"text":"クエストに出発","color": "#ff9900","bold": true},{"text":" します。\n","color": "#00FFC3","bold": false},\
        {"text":"  ","color": "#00FFC3","bold": false},{"text":"クエスト受注者と参加者全員が","color": "#ff9900","bold": true},{"text":" フィールドに移動します。\n","color": "#00FFC3","bold": false},\
