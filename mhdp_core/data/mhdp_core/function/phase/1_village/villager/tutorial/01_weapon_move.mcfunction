...
# 遷移：移動後
    execute if score @s Vlg.General.Timer matches 100.. positioned 239 63 198 if entity @a[tag=!Ply.State.PlayingQuest,distance=..7] run function mhdp_core:phase/1_village/villager/tutorial/change_phase
