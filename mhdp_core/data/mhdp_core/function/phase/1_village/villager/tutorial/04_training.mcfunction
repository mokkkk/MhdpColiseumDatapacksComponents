...
# チュートリアル表示
    ...
    execute if score @s Vlg.General.Timer matches 10 run tellraw @a[tag=!Ply.State.PlayingQuest] [\
        ...
        {"text":"  ここから ","color": "#00FFC3","bold": false},{"text":" 訓練所 ","color": "#ff9900","bold": true},{"text":" に移動できます。\n","color": "#00FFC3","bold": false},\
        {"text":"  訓練所では、武器の操作方法などのチュートリアルを受けられます。\n","color": "#00FFC3","bold": false},\
        {"text":"  ","color": "#00FFC3","bold": false},{"text":"チュートリアルクエストクリア後に利用できるようになる","color": "#ff9900","bold": true},{"text":" ので、\n","color": "#00FFC3","bold": false},\
