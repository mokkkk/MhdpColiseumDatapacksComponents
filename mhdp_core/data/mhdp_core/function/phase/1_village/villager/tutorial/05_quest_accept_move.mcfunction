...
# 遷移：移動後
    execute if score @s Vlg.General.Timer matches 100.. positioned -79 69 775 if entity @a[tag=!Ply.State.PlayingQuest,distance=..4] run function mhdp_core:phase/1_village/villager/tutorial/change_phase
