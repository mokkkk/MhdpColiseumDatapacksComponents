...
# リタイア用ベルのinteraction召喚
    ...
    execute positioned 216 68 147 unless entity @n[type=interaction,tag=Other.Text.Bell,distance=..2] run summon text_display 216 68 147 {view_range:0.1f,width:1.5f,height:1.5f,billboard:"vertical",default_background:1b,Tags:["Other.Text.Bell"],text:'{"bold":true,"color":"white","text":"クエストリタイア"}',alignment:"center"}
