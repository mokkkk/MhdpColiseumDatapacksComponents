...
# データ付与
    $item modify block 0 0 0 container.0 {function:set_custom_data,tag:{IsUsing:1b,IsSubWeapon:0b,IsDrawing:0b,CurrentSharpness:$(CurrentSharpness),CurrentSharpnessColor:$(SharpnessColor)}}
