...
execute if entity @s[tag=aj.dino_aj.animation.state_paralysis_start.playing] run function animated_java:dino_aj/animations/state_paralysis_start/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.state_paralysis.playing] run function animated_java:dino_aj/animations/state_paralysis/zzz/on_tick
...
execute if entity @s[tag=aj.dino_aj.animation.damage_counter_head_start.playing] run function animated_java:dino_aj/animations/damage_counter_head_start/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.damage_counter_tail_right_start.playing] run function animated_java:dino_aj/animations/damage_counter_tail_right_start/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.damage_counter_tail_left_start.playing] run function animated_java:dino_aj/animations/damage_counter_tail_left_start/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.damage_counter.playing] run function animated_java:dino_aj/animations/damage_counter/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.damage_counter_mirror.playing] run function animated_java:dino_aj/animations/damage_counter_mirror/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.damage_counter_end.playing] run function animated_java:dino_aj/animations/damage_counter_end/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.damage_counter_end_mirror.playing] run function animated_java:dino_aj/animations/damage_counter_end_mirror/zzz/on_tick
...
execute if entity @s[tag=aj.dino_aj.animation.turn_bite_r.playing] run function animated_java:dino_aj/animations/turn_bite_r/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.turn_bite_l.playing] run function animated_java:dino_aj/animations/turn_bite_l/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.step_side_r.playing] run function animated_java:dino_aj/animations/step_side_r/zzz/on_tick
...
execute if entity @s[tag=aj.dino_aj.animation.bite_to_tail.playing] run function animated_java:dino_aj/animations/bite_to_tail/zzz/on_tick
...
execute if entity @s[tag=aj.dino_aj.animation.breath_move_r.playing] run function animated_java:dino_aj/animations/breath_move_r/zzz/on_tick
...
execute if entity @s[tag=aj.dino_aj.animation.tail_attack_r_to_step_r.playing] run function animated_java:dino_aj/animations/tail_attack_r_to_step_r/zzz/on_tick
execute if entity @s[tag=aj.dino_aj.animation.tail_attack_l_to_step_l.playing] run function animated_java:dino_aj/animations/tail_attack_l_to_step_l/zzz/on_tick
