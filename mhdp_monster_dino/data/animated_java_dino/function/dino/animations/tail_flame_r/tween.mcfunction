...
tag @s add animated_java_dino.dino.animation.tail_flame_r.playing
...
execute at @s run function animated_java_dino:dino/animations/tail_flame_r/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java_dino:dino/animations/tail_flame_r/zzz/apply_frame {frame: $(to_frame)}
