...
tag @s add animated_java_dino.dino.animation.idle.playing
...
execute at @s run function animated_java_dino:dino/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java_dino:dino/animations/idle/zzz/apply_frame {frame: $(to_frame)}
