...
# 移動
    ...
    execute if score @s aj.bite.frame matches 20..25 unless entity @n[tag=Mns.Target.Dino,distance=..7] at @s run tp @s ^ ^ ^0.4
...
# 攻撃
    execute if score @s aj.bite.frame matches 22..25 run function mhdp_monster_dino:core/tick/animation/event/bite/attack_head
