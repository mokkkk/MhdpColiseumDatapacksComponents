...
# フェーズ
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.roundforce.frame matches 80 run function mhdp_monster_dino:core/util/phase/tail_heat_check
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.roundforce.frame matches 81 run function mhdp_monster_dino:core/util/phase/tail_heat_check
