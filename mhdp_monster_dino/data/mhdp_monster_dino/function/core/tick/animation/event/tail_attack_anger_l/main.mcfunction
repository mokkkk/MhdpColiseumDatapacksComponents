...
# 軸合わせ・弱め
    execute if score @s aj.tail_attack_anger_l.frame matches 2 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:10,MaxRotation:180}
    execute if score @s aj.tail_attack_anger_l.frame matches 10 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:10,MaxRotation:180}
    execute if score @s aj.tail_attack_anger_l.frame matches 2..18 at @s run function mhdp_monsters:core/util/tick/event/alignment
...
# 移動
    ...
    execute if score @s aj.tail_attack_anger_l.frame matches 81..87 at @s run tp @s ^ ^ ^-0.1
...
# 攻撃
    ...
    execute if score @s aj.tail_attack_anger_l.frame matches 23 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_l/attack_tail_start.m {Rotate:-50}
    execute if score @s aj.tail_attack_anger_l.frame matches 24 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_l/attack_tail_start.m {Rotate:-30}
    execute if score @s aj.tail_attack_anger_l.frame matches 25 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_l/attack_tail_start.m {Rotate:-10}
...
# フェーズ
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.tail_attack_anger_l.frame matches 26 run function mhdp_monster_dino:core/util/phase/tail_heat_check
