...
# 弱めの軸合わせ
    ...
    execute if score @s aj.jump_tail_r.frame matches 30..34 at @s run function mhdp_monsters:core/util/other/turn_to_target_rotate
...
# 移動
    ...
    execute if score @s aj.jump_tail_r.frame matches 24..34 at @s run function mhdp_monsters:core/util/other/move_to_target_move
