...
# 移動
    ...
    execute if score @s aj.breath_move_l.frame matches 36..45 at @s run tp @s ^1.2 ^ ^0.6
...
# 効果音
    ...
    execute if score @s aj.breath.frame matches 20..37 run function animated_java_dino:dino/at_locator {name:"pos_head",command:"function mhdp_monster_dino:core/tick/animation/event/breath_move_l/particle_head"} 
    execute if score @s aj.breath_move_l.frame matches 38..42 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound minecraft:entity.ravager.attack master @s ^ ^1 ^1 0.4 0.8 0.4
    execute if score @s aj.breath_move_l.frame matches 38..42 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound minecraft:entity.hoglin.attack master @s ^ ^1 ^1 0.4 0.65 0.4
    execute if score @s aj.breath_move_l.frame matches 38..49 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound minecraft:item.mace.smash_ground master @s ^ ^1 ^1 0.4 0.8 0.4
    execute if score @s aj.breath_move_l.frame matches 38..49 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound minecraft:item.mace.smash_ground master @s ^ ^1 ^1 0.4 0.6 0.4
    ...
    execute if score @s aj.breath_move_l.frame matches 13 run particle block{block_state:"minecraft:sand"} ^ ^0.1 ^2 1.8 0.1 1.8 0 30
...
# 攻撃
    execute if score @s aj.breath_move_l.frame matches 33 positioned as @n[tag=Mns.Target.Dino] run summon area_effect_cloud ~ ~0.1 ~ {Duration:10,DurationOnUse:0,Tags:["Mns.ShotPos.Dino"],custom_particle:{type:"block",block_state:"minecraft:air"}}
    execute if score @s aj.breath_move_l.frame matches 38 run function animated_java_dino:dino/at_locator {name:"pos_head",command:"function mhdp_monster_dino:core/tick/animation/event/breath_move_l/attack"} 
