#> mhdp_monster_dino:core/tick/animation/event/turn_bite_l/attack_head
#
...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_dino:core/tick/animation/event/turn_bite_l/m.attack_head with entity @s data.locators.pos_head
