#> mhdp_monster_dino:core/tick/animation/event/tail_flame_r/attack_tail
#
...
# デバッグ用
    ...
    #         Player_Scale_X:2.5,Player_Scale_Y:2.2,Player_Scale_Z:2.0,\
    ...
    #         Entity_Scale_X:2.5,Entity_Scale_Y:2.2,Entity_Scale_Z:3.5\
    # }
