...
# 軸合わせ
    execute if score @s aj.tail_attack_l_to_step_l.frame matches 1 run function mhdp_monster_dino:core/tick/animation/event/tail_attack_l_to_step_l/turn_start
