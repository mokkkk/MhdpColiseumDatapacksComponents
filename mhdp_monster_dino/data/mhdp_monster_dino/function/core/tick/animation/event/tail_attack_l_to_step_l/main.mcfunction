...
# フェーズ
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.tail_attack_l_to_step_l.frame matches 26 run function mhdp_monster_dino:core/util/phase/tail_heat_check
