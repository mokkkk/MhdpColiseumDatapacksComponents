...
# 攻撃
    execute if score @s aj.bite_double_normal.frame matches 18 run function mhdp_monsters:core/util/tick/event/start_attack.m with storage mhdp_core:monster_data AttackData[{Uid:1003}].Attacks[{Name:"BiteDouble"}]
    execute if score @s aj.bite_double_normal.frame matches 18..22 run function animated_java_dino:dino/at_locator {name:"pos_head",command:"function mhdp_monster_dino:core/tick/animation/event/bite_double_normal/attack_head"}
    ...
    execute if score @s aj.bite_double_normal.frame matches 28..32 run function animated_java_dino:dino/at_locator {name:"pos_head",command:"function mhdp_monster_dino:core/tick/animation/event/bite_double_normal/attack_head"}
    ...
    execute if score @s aj.bite_double_normal.frame matches 32 run function mhdp_monsters:core/util/tick/event/end_attack
