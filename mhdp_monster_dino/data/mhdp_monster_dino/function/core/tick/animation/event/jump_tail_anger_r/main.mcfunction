...
# 攻撃
    execute if score @s aj.jump_tail_anger_r.frame matches 37 run tag @s remove Mns.Temp.Attack.Tail.R
    ...
    execute if score @s aj.jump_tail_anger_r.frame matches 66 run tag @s remove Mns.Temp.Attack.Tail.L
