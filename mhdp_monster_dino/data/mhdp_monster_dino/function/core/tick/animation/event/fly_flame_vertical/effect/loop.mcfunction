#> mhdp_monster_reus:core/tick/animation/event/fly_flame_vertical/effect/loop
#
...
# 移動
    ...
    execute if score @s MhdpCore matches 0 run tp @s ~ ~ ~ ~ ~
    execute if score @s MhdpCore matches 0 run scoreboard players remove @s MhdpCore 1
    execute if score @s MhdpCore matches 1.. positioned ^ ^ ^1 run function mhdp_monster_reus:core/tick/animation/event/fly_flame_vertical/effect/loop
