...
# デバッグ用
    # function api:bounding/cuboid_preview.m {Uid:1003,AttackName:"Bite",\
...
# 攻撃実行
    execute if entity @s[tag=!Mns.Dino.State.HeadHeat] run function mhdp_monsters:core/util/tick/event/apply_attack.m {Uid:1003,AttackName:"Bite",\
        Player_Selector:"@a[tag=Ply.State.EnableDamage,distance=..30]",\
            Player_Offset_X:1.0,Player_Offset_Y:1.0,Player_Offset_Z:1.0,\
            Player_Scale_X:2.0,Player_Scale_Y:2.0,Player_Scale_Z:2.0,\
        Entity_Selector:"@e[type=slime,tag=Entity.EnableDamage,tag=!Mns.HitBox.Dino,distance=..30]",\
    ...
    execute if entity @s[tag=Mns.Dino.State.HeadHeat] run function mhdp_monsters:core/util/tick/event/apply_attack.m {Uid:1003,AttackName:"Bite.Heat",\
        Player_Selector:"@a[tag=Ply.State.EnableDamage,distance=..30]",\
            Player_Offset_X:1.0,Player_Offset_Y:1.0,Player_Offset_Z:1.0,\
            Player_Scale_X:2.0,Player_Scale_Y:2.0,Player_Scale_Z:2.0,\
        Entity_Selector:"@e[type=slime,tag=Entity.EnableDamage,tag=!Mns.HitBox.Dino,distance=..30]",\
