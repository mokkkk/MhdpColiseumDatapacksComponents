...
# 効果音
    ...
    execute if score @s aj.breath.frame matches 2..24 run function animated_java_dino:dino/at_locator {name:"pos_head",command:"function mhdp_monster_dino:core/tick/animation/event/breath/particle_head"} 
