...
# 軸合わせ・弱め
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 2 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:10,MaxRotation:180}
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 10 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:10,MaxRotation:180}
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 2..18 at @s run function mhdp_monsters:core/util/tick/event/alignment
...
# 攻撃
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 20 run tag @s remove Mns.Temp.Attack.Tail.R
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 20 run function mhdp_monsters:core/util/tick/event/start_attack.m with storage mhdp_core:monster_data AttackData[{Uid:1003}].Attacks[{Name:"Tail"}]
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 21 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/attack_tail_start.m {Rotate:-90}
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 22 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/attack_tail_start.m {Rotate:-70}
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 23 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/attack_tail_start.m {Rotate:-50}
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 24 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/attack_tail_start.m {Rotate:-30}
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 25 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/attack_tail_start.m {Rotate:-10}
    ...
    execute if score @s aj.tail_attack_r_to_step_r.frame matches 27 run function mhdp_monsters:core/util/tick/event/end_attack

# 接地
    function mhdp_monsters:core/util/tick/move/check_landing

# フェーズ
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.tail_attack_r_to_step_r.frame matches 26 run function mhdp_monster_dino:core/util/phase/tail_heat_check
