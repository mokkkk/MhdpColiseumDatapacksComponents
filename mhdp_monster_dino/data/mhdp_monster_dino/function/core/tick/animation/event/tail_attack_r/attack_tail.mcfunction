#> mhdp_monster_dino:core/tick/animation/event/tail_attack_r/attack_head
#
...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r/m.attack_tail with entity @s data.locators.pos_tail_1
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r/m.attack_tail with entity @s data.locators.pos_tail_2
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_dino:core/tick/animation/event/tail_attack_r/m.attack_tail with entity @s data.locators.pos_tail_3
