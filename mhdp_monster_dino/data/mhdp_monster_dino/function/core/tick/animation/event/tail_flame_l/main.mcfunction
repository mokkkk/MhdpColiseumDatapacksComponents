...
# 状態更新
    execute if score @s aj.tail_flame_l.frame matches 20 run tag @s add Mns.Dino.State.Attack.Tail.L
    execute if score @s aj.tail_flame_l.frame matches 50 run tag @s remove Mns.Dino.State.Attack.Tail.L
