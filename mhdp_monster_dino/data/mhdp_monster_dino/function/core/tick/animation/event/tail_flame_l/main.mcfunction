...
# 効果音
    ...
    execute if score @s aj.tail_flame_l.frame matches 67..73 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @n feet as @p run playsound minecraft:entity.ravager.attack master @s ^ ^1 ^-1 0.4 0.8 0.4
    execute if score @s aj.tail_flame_l.frame matches 67..73 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @n feet as @p run playsound minecraft:entity.hoglin.attack master @s ^ ^1 ^-1 0.4 0.65 0.4
    execute if score @s aj.tail_flame_l.frame matches 67..68 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @n feet as @p run playsound minecraft:item.mace.smash_ground master @s ^ ^1 ^-1 0.4 0.8 0.4
    execute if score @s aj.tail_flame_l.frame matches 67..68 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @n feet as @p run playsound minecraft:item.mace.smash_ground master @s ^ ^1 ^-1 0.4 0.6 0.4
