...
# 軸合わせ
    execute if score @s aj.jump_tail_l.frame matches 2 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:5,MaxRotation:999}
    execute if score @s aj.jump_tail_l.frame matches 6 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:5,MaxRotation:999}
    execute if score @s aj.jump_tail_l.frame matches 11 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:5,MaxRotation:999}
    execute if score @s aj.jump_tail_l.frame matches 30 run function mhdp_monsters:core/util/tick/event/alignment_start.m {TargetTag:"Mns.Target.Dino",Tick:10,MaxRotation:999}
    execute if score @s aj.jump_tail_l.frame matches 2..15 at @s run function mhdp_monsters:core/util/tick/event/alignment
    execute if score @s aj.jump_tail_l.frame matches 30..35 at @s run function mhdp_monsters:core/util/tick/event/alignment

# 移動
    execute if score @s aj.jump_tail_l.frame matches 1..5 if entity @n[tag=Mns.Target.Dino,distance=..8] at @s run tp @s ^ ^ ^-0.2
    execute if score @s aj.jump_tail_l.frame matches 23 at @s run function mhdp_monsters:core/util/tick/event/vector_move_start.m {\
        TargetType:"player",TargetTag:"Mns.Target.Dino",MaxDistance:35,Tick:14,OffsetX:0.0,OffsetY:0.0,OffsetZ:-7.0,IsAdjustLand:"true"\
    }
    execute if score @s aj.jump_tail_l.frame matches 24..37 at @s run function mhdp_monsters:core/util/tick/event/vector_move
...
# 攻撃
    execute if score @s aj.jump_tail_l.frame matches 37 run tag @s remove Mns.Temp.Attack.Tail.L
    execute if score @s aj.jump_tail_l.frame matches 37 run function mhdp_monsters:core/util/tick/event/start_attack.m with storage mhdp_core:monster_data AttackData[{Uid:1003}].Attacks[{Name:"TailJump"}]
    execute if score @s aj.jump_tail_l.frame matches 38 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_l/attack_tail_start.m {Rotate:-90}
    execute if score @s aj.jump_tail_l.frame matches 39 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_l/attack_tail_start.m {Rotate:-80}
    execute if score @s aj.jump_tail_l.frame matches 40 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_l/attack_tail_start.m {Rotate:-60}
    execute if score @s aj.jump_tail_l.frame matches 41 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_l/attack_tail_start.m {Rotate:-40}
    execute if score @s aj.jump_tail_l.frame matches 42 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_l/attack_tail_start.m {Rotate:-20}
    ...
    execute if score @s aj.jump_tail_l.frame matches 44 run function mhdp_monsters:core/util/tick/event/end_attack

# 接地
    function mhdp_monsters:core/util/tick/move/check_landing

# フェーズ
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.jump_tail_l.frame matches 43 run function mhdp_monster_dino:core/util/phase/tail_heat_check
