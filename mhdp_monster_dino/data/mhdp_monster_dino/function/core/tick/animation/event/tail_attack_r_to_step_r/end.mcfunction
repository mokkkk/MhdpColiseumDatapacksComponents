#> mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/end
#
# アニメーションイベントハンドラ 尻尾叩きつけ
#
# @within function mhdp_monster_dino:core/tick/animation/event/tail_attack_r_to_step_r/main
