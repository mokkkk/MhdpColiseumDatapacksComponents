...
# 軸合わせ
    execute if score @s aj.turn_bite_r.frame matches 2 run function mhdp_monster_dino:core/tick/animation/event/turn_bite_r/turn_start
...
# 攻撃
    execute if score @s aj.turn_bite_r.frame matches 10..16 run function mhdp_monster_dino:core/tick/animation/event/turn_bite_r/attack_head
