...
# 移動
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 23 at @s run function mhdp_monsters:core/util/tick/event/vector_move_start.m {\
        TargetType:"player",TargetTag:"Mns.Target.Dino",MaxDistance:35,Tick:14,OffsetX:0.0,OffsetY:0.0,OffsetZ:-7.0,IsAdjustLand:"true"\
    }
    execute if score @s aj.jump_tail_anger_l.frame matches 24..37 at @s run function mhdp_monsters:core/util/tick/event/vector_move
...
# 効果音
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 72..77 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound minecraft:item.mace.smash_ground master @s ^ ^1 ^1 0.4 0.8 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 72..74 at @a[tag=!Ply.State.IsSilent,distance=..32] facing entity @s feet as @p run playsound minecraft:item.mace.smash_ground master @s ^ ^1 ^1 0.4 0.6 0.4
...
# 攻撃
    execute if score @s aj.jump_tail_anger_l.frame matches 37 run tag @s add Mns.Temp.Attack.Tail.L
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 40 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_l/attack_tail_start_1.m {Rotate:-60}
    execute if score @s aj.jump_tail_anger_l.frame matches 41 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_l/attack_tail_start_1.m {Rotate:-40}
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 66 run tag @s add Mns.Temp.Attack.Tail.R
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 69 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_l/attack_tail_start_0.m {Rotate:-60}
    execute if score @s aj.jump_tail_anger_l.frame matches 70 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_l/attack_tail_start_0.m {Rotate:-40}
    execute if score @s aj.jump_tail_anger_l.frame matches 71 at @s run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_l/attack_tail_start_0.m {Rotate:-20}
    execute if score @s aj.jump_tail_anger_l.frame matches 72 run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_l/attack_0
    execute if score @s aj.jump_tail_anger_l.frame matches 73 run function mhdp_monsters:core/util/tick/event/end_attack

# 接地
    function mhdp_monsters:core/util/tick/move/check_landing

# フェーズ
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.jump_tail_anger_l.frame matches 43 run function mhdp_monster_dino:core/util/phase/tail_heat_check
    execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.jump_tail_anger_l.frame matches 71 run function mhdp_monster_dino:core/util/phase/tail_heat_check
