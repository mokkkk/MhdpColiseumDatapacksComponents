...
# 弱めの軸合わせ
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 30..39 at @s run function mhdp_monsters:core/util/other/turn_to_target_rotate
    execute if score @s aj.jump_tail_anger_l.frame matches 58..67 at @s run function mhdp_monsters:core/util/other/turn_to_target_rotate
...
# 効果音
    ...
    execute if score @s aj.jump_tail_anger_l.frame matches 43..48 run playsound minecraft:entity.ravager.attack master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.8 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 43..45 run playsound minecraft:entity.hoglin.attack master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.65 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 72..77 run playsound minecraft:entity.ravager.attack master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.8 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 72..74 run playsound minecraft:entity.hoglin.attack master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.65 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 128..134 run playsound minecraft:entity.ravager.attack master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.8 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 128..134 run playsound minecraft:entity.hoglin.attack master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.65 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 128..129 run playsound minecraft:item.mace.smash_ground master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.8 0.4
    execute if score @s aj.jump_tail_anger_l.frame matches 128..129 run playsound minecraft:item.mace.smash_ground master @a[tag=!Ply.State.IsSilent,distance=..48] ~ ~ ~ 1 0.6 0.4
