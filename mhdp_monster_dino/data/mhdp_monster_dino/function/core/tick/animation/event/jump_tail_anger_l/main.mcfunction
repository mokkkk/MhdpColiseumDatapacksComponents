...
# フェーズ
    # execute if entity @s[tag=!Mns.Dino.State.TailHeat] if score @s aj.jump_tail_anger_l.frame matches 26 run function mhdp_monster_dino:core/util/phase/tail_heat
