#> mhdp_monster_reus:core/tick/animation/event/land_state_paralysis_end/end
#
# アニメーションイベントハンドラ 麻痺終了
#
# @within function mhdp_monster_reus:core/tick/animation/event/land_state_paralysis_end/main
