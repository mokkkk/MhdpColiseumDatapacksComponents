...
# 移動
    ...
    execute if score @s aj.tail_back_r.frame matches 36..40 at @s run tp @s ^ ^ ^-0.1 ~-14 ~
    execute if score @s aj.tail_back_r.frame matches 41..44 at @s run tp @s ^0.5 ^ ^-0.3 ~-12 ~
    execute if score @s aj.tail_back_r.frame matches 45..55 at @s run tp @s ^0.2 ^ ^-0.15 ~-1 ~
    execute if score @s aj.tail_back_r.frame matches 56..60 at @s run tp @s ^0.1 ^ ^-0.05 ~-0.2 ~
...
# 攻撃
    execute if score @s aj.tail_back_r.frame matches 36..44 run function mhdp_monster_dino:core/tick/animation/event/tail_back_r/attack_tail
