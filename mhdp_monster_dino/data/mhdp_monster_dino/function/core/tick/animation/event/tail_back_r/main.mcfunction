...
# 移動
    execute if score @s aj.tail_back_r.frame matches 31 at @s run function mhdp_monster_dino:core/tick/animation/event/tail_back_r/move_start
    execute if score @s aj.tail_back_r.frame matches 34..43 at @s run function mhdp_monsters:core/util/other/move_to_target_move
