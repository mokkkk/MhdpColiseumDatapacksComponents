...
# 遷移
    execute if entity @s[tag=!Mns.Dino.Combo.ToBite] positioned ^ ^ ^5 if entity @n[tag=Mns.Target.Dino,distance=..9] positioned as @s run function mhdp_monster_dino:core/tick/animation/event/move/change
    execute if entity @s[tag=Mns.Dino.Combo.ToBite] positioned ^ ^ ^8 if entity @n[tag=Mns.Target.Dino,distance=..7] positioned as @s run function mhdp_monster_dino:core/tick/animation/event/move/change
    execute unless entity @e[tag=Mns.Target.Dino] run function mhdp_monster_dino:core/tick/animation/event/move/end
