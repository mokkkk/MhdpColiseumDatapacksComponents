#> mhdp_monster_reus:core/tick/animation/event/fly_bite/attack
#
# アニメーションイベントハンドラ 飛行嚙みつき
#
# @within function mhdp_monster_reus:core/tick/animation/event/tick

# データ読み込み
    data modify storage mhdp_core:temp Damage set from storage mhdp_core:monster_data AttackData[{Uid:1002}].Attacks[{Name:"FlyBite"}]
