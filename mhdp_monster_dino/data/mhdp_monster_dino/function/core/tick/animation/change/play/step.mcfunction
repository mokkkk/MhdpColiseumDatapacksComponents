#> mhdp_monster_dino:core/tick/animation/change/play/step
#
# アニメーション変更処理 尻尾攻撃・背面
#
...
# 再生アニメーション決定
    execute if entity @s[tag=Mns.Temp.Right] run tag @s add Anim.Step.L
    execute if entity @s[tag=!Mns.Temp.Right] run tag @s add Anim.Step.R
