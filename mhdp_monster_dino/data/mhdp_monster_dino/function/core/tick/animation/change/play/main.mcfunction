...
# 尻尾攻撃
    execute if entity @s[tag=Anim.Tail.R] run function animated_java:dino_aj/animations/tail_attack_r/tween {duration:6, to_frame: 3}
    execute if entity @s[tag=Anim.Tail.L] run function animated_java:dino_aj/animations/tail_attack_l/tween {duration:6, to_frame: 3}
    execute if entity @s[tag=Anim.Tail.Anger.R] run function animated_java:dino_aj/animations/tail_attack_anger_r/tween {duration:6, to_frame: 3}
    execute if entity @s[tag=Anim.Tail.Anger.L] run function animated_java:dino_aj/animations/tail_attack_anger_l/tween {duration:6, to_frame: 3}
    execute if entity @s[tag=Anim.Tail.Step.R] run function animated_java:dino_aj/animations/tail_attack_r_to_step_r/tween {duration:6, to_frame: 3}
    execute if entity @s[tag=Anim.Tail.Step.L] run function animated_java:dino_aj/animations/tail_attack_l_to_step_l/tween {duration:6, to_frame: 3}
# 尻尾攻撃・側面
