...
# 戦闘時
    execute if entity @s[tag=!Mns.Temp.IsAlreadyAnsimation] if score @s Mns.General.Phase matches 2 run function mhdp_monster_dino:core/tick/animation/change/on_battle/main
