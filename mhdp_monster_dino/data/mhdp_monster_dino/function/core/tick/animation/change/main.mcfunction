...
# アニメーション選択
    # execute if entity @s[tag=!Mns.Temp.IsAlreadyAnimation,tag=!Mns.Temp.IsTurn,tag=!Mns.State.IsNotMove] if entity @e[tag=Mns.Target.Dino] run function mhdp_monster_dino:core/tick/animation/change/random/main
