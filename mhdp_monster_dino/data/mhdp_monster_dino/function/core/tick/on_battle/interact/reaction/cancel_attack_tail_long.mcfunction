#> mhdp_monster_dino:core/tick/on_battle/interact/reaction/cancel_attack_tail_long
#
...
# アニメーション再生処理
    # アニメーション再生
        execute if entity @s[tag=Mns.Temp.Attack.Tail.R] run function animated_java_dino:dino/animations/tail_interrupt_long_r/tween {duration:1, to_frame: 1}
        execute unless entity @s[tag=Mns.Temp.Attack.Tail.R] run function animated_java_dino:dino/animations/tail_interrupt_long_l/tween {duration:1, to_frame: 1}
    # 演出
