#> mhdp_monster_dino:core/tick/on_battle/start
#
# tick処理 戦闘中 開始
#
...
# 初回遭遇時
    # この時点で発見されているプレイヤーに大きなヘイトを与える
        execute as @a[tag=Mns.Candidate.Dino,scores={Mns.Dino.Search=1000..}] run scoreboard players add @s Mns.Dino.Hate 300
    # 咆哮アニメーション再生
