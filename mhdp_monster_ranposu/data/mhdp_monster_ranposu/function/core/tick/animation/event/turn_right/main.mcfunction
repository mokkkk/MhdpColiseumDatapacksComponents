...
# 軸合わせ
    execute if score @s aj.frame matches 1 run function mhdp_monster_ranposu:core/tick/animation/event/turn_right/turn_start
...
# 終了
    execute if score @s aj.frame matches 19 run function mhdp_monster_ranposu:core/tick/animation/event/turn_right/end
