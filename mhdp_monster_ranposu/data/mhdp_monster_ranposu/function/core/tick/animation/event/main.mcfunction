...
# 怯み
    ...
    # 建築物攻撃時の怯み
        ...
        execute if entity @s[tag=animated_java.ranposu.animation.interrupt_object_tackle.playing] run function mhdp_monster_ranposu:core/tick/animation/event/interrupt_object_tackle/main
