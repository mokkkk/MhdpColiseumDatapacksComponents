...
# 移動
    ...
    execute if score @s aj.frame matches 28 at @s run function mhdp_monster_ranposu:core/tick/animation/event/step_jump_right/move_start
...
# 攻撃
    execute if score @s aj.frame matches 32..44 run function mhdp_monster_ranposu:core/tick/animation/event/step_jump_right/attack
...
# 終了
    execute if score @s aj.frame matches 99 run function mhdp_monster_ranposu:core/tick/animation/event/step_jump_right/end
