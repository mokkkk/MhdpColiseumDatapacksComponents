...
# 攻撃
    ...
    execute if score @s aj.step_jump_right.frame matches 32..44 run function animated_java:ranposu/at_locator {name:"pos_head",command:"function mhdp_monster_ranposu:core/tick/animation/event/step_jump_right/attack"}
