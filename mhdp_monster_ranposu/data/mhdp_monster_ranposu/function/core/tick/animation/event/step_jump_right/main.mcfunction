...
# 攻撃
    ...
    execute if score @s aj.step_jump_right.frame matches 32..44 run function animated_java_ranposu:ranposu/at_locator {name:"pos_head",command:"function mhdp_monster_ranposu:core/tick/animation/event/step_jump_right/attack"}
    execute if score @s aj.step_jump_right.frame matches 45 run function mhdp_monsters:core/util/tick/event/end_attack
