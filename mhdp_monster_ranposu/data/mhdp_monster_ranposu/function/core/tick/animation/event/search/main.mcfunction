...
# 効果音
    ...
    execute if score @s aj.frame matches 25 run playsound block.grass.step master @a[tag=!Ply.State.IsSilent] ~ ~ ~ 2 1
...
# 終了
    execute if score @s aj.frame matches 74 run function mhdp_monster_ranposu:core/tick/animation/event/search/end
