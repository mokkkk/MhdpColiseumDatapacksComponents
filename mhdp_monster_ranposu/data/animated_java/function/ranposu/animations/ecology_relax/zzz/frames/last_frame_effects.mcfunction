...
$execute as $(hitbox_body_0) positioned ^0 ^0.7872396333 ^-0.3688461571 rotated ~0 ~-12.5 run function animated_java:ranposu/animations/ecology_relax/zzz/frames/74_locator_hitbox_body_0
$execute as $(hitbox_body_1) positioned ^0 ^1.0013499876 ^1.5389264496 rotated ~0 ~0 run function animated_java:ranposu/animations/ecology_relax/zzz/frames/74_locator_hitbox_body_1
execute positioned ^0 ^2.8391174345 ^2.796024501 rotated ~0 ~2.5 run function animated_java:ranposu/animations/ecology_relax/zzz/frames/74_locator_pos_head
