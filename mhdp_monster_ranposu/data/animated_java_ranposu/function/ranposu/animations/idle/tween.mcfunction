...
tag @s add animated_java_ranposu.ranposu.animation.idle.playing
...
execute at @s run function animated_java_ranposu:ranposu/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java_ranposu:ranposu/animations/idle/zzz/apply_frame {frame: $(to_frame)}
