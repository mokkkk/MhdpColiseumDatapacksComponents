...
tag @s add animated_java.karakuri.animation.idle.playing
...
execute at @s run function animated_java:karakuri/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:karakuri/animations/idle/zzz/apply_frame {frame: $(to_frame)}
