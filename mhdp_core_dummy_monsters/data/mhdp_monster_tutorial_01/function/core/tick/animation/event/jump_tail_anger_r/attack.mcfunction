#> mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_r/attack
#
...
# 演出
    ...
    execute positioned ^ ^1 ^11 run function mhdp_monster_dino:core/tick/animation/event/jump_tail_anger_r/attack_particle
