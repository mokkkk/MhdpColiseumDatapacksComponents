#> mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_r/attack
#
...
# 演出
    execute positioned ^ ^1 ^7 run function mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_r/attack_particle
    execute positioned ^ ^1 ^9 run function mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_r/attack_particle
    execute positioned ^ ^1 ^11 run function mhdp_monster_dino:core/tick/animation/event/tail_attack_anger_r/attack_particle
