...
execute if score @s aj.pose.frame matches -1 run function animated_java:ranposu/animations/pose/zzz/commands_keyframe_loop_patch
...
function animated_java:ranposu/animations/pose/zzz/apply_frame with storage aj:temp args
