...
# 位置決定
    execute positioned as @n[tag=Mns.Target.Valk] facing entity @s feet rotated ~ 0 positioned ^ ^0.5 ^6 run summon area_effect_cloud ^ ^ ^ {Duration:200,DurationOnUse:0,Tags:["Mns.MovePos.Valk"]}
