#> mhdp_monster_valk:core/tick/animation/change/random/lance_middle
#
# 行動ランダム選択
#
...
# 決定
    function mhdp_monster_valk:core/tick/animation/change/random/macro/m.lance_middle with storage mhdp_core:temp Temp.AttackRandom
