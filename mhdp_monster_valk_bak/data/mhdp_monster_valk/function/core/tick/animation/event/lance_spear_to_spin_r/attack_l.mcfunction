#> mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_r/attack_l
#
...
# ヒット確認
    # 対プレイヤー
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_r/m.attack with entity @s data.locators.pos_wing_r_1
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_r/m.attack with entity @s data.locators.pos_wing_r_2
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_r/m.attack with entity @s data.locators.pos_wing_r_3
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_r/m.attack with entity @s data.locators.pos_wing_r_4
        execute on passengers if entity @s[tag=aj.data] run function mhdp_monster_valk:core/tick/animation/event/lance_spear_to_spin_r/m.attack with entity @s data.locators.pos_wing_r_5
