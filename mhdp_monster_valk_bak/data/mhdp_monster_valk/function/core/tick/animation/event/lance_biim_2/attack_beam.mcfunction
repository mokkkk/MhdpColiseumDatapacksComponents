...
# 壁に当たるまで再帰
    ...
    $execute positioned ^$(posx) ^$(posy) ^$(posz) facing entity @n[type=area_effect_cloud,tag=Mns.BeamPos.Valk] feet run function mhdp_monster_valk:core/tick/animation/event/lance_biim_2/attack_beam_loop
