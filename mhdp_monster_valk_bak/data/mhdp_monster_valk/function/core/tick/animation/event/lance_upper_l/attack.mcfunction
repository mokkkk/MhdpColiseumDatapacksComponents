...
# ヒット確認
    execute positioned ^ ^ ^ run function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_sub
    execute positioned ^ ^ ^5 run function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_sub
    execute positioned ^ ^ ^10 run function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_sub
    execute positioned ^ ^ ^15 run function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_sub
    execute positioned ^ ^ ^20 run function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_sub
    execute positioned ^ ^ ^25 run function mhdp_monster_valk:core/tick/animation/event/lance_upper_l/attack_sub
